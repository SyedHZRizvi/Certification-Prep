# ✏️ Module 1 Quiz: Supply Management Foundations
...
D. Resolving an invoice dispute
...
D. Defer to the CFO without comment
...
D. New entrants are flooding the market
...
D. Handles only IT category spend
...
D. A risk to be minimized through legal contracts only
...
D. Internal customers bypassing supply mgmt
...
D. Procurement is buried two levels below operations
...
D. Outsource the entire department
...
D. The personal preference of the buyer
...
D. Tell Marketing to delay the launch
...
D. A cost-leader firm enters joint R&D partnerships with multiple small specialty suppliers
...
D. Risk and ethics oversight of the supply base
...
D. Headcount in the procurement function
...
D. Refer the friend's company to a different department to avoid the conflict
...
C. Adopt blockchain
D. Outsource procurement to a third party
...
### Q3: **B. Push back**
Alignment matters. Reverse auctions on innovation-critical categories destroy collaboration. The role of the supply professional is to coach leadership on category-appropriate sourcing.

### Q4: **B. One global supplier, no substitutes, high switching costs**
...
### Q9: **C. Right relationship**
The classic Five Rights are quality, quantity, time, place, price. "Right relationship" is a modern addition, but not part of the classic five.

### Q10: **B. Strategic importance and IP protection**
Proprietary content with trade secrets is a classic "make" case to protect IP and core competence.

### Q11: **C. Partners whose performance and innovation drive joint value**
...
### Q14: **B. Customers swap to a different product entirely**
Substitutes are different *products* that satisfy the same need (e.g., video calls replacing business travel). Competitors offering similar products are "industry rivalry."

### Q15: **B. Supplier-enabled innovation contributes to revenue**
World-class supply creates competitive advantage, not just cost savings.

### Q16: **B. Delegate tactical work; refocus on strategy**
Senior leaders own strategy. Spending 60% on tactical issues is a sign of role mismatch.

### Q17: **D. Personal preference of the buyer**
...
### Q20: **C. Outbound logistics**
Primary activities (Porter): inbound logistics, operations, outbound logistics, marketing & sales, service. The other three are support.

### Q21: **A. Cost-leader consolidates spend with lowest-priced suppliers**
...
### Q24: **C. Balanced set of metrics**
Modern supply uses balanced scorecards (TCO, risk, innovation, ESG, delivery, quality), not single-axis metrics.

### Q25: **C. Decline, explain policy, escalate if pressured**
Ethics scenario. The supply professional protects the integrity of the process. Skipping = conflict of interest and policy violation. Module 7 reinforces this.

### Q26: **B. Spend analysis and category strategies**
The classic Stage-2 → Stage-3 lever. Without spend visibility you can't strategize.

---

## 📊 Score Yourself

- 24–26 → 🏆 You own Module 1. Onward.
- 21–23 → ✅ Solid. Note misses, then continue.
- 17–20 → ⚠️ Re-read the sections you missed; re-quiz tomorrow.
- <17 → 🔁 Re-read Reading.md fully and re-watch videos.

---

## 🃏 Add To Your Flashcards

- The four org models (centralized / decentralized / hybrid / CoE) and their trade-offs
- Porter's Five Forces and what each implies for supply
- The 5-stage maturity model
- The Five Rights
- Make-or-buy decision factors
- The 11-step supply management process (Module 1 diagram)

---

➡️ Next: [Cheat-Sheet.md](./Cheat-Sheet.md) for one-page review, then [Module 2: Category Management & Sourcing](../Module-02-Category-Management-Sourcing/Reading.md)
