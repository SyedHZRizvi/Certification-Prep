# ✏️ Module 8 Quiz: Leadership & Project Management

> **Instructions:** 26 questions, no notes. Target 21/26. Many are judgment scenarios.
...
D. Hide other adopters' identities
...
C. Add features
D. Penalize non-users immediately
...
D. The supplier's competitors only
...
D. Resign and tell nobody

---

## 🎯 Answers + Explanations

### Q1: **B.** Create urgency. (Step 1.)
...
### Q10: **B.** (O + 4M + P) / 6.
### Q11: **B.** Poor stakeholder + change management.
### Q12: **A.** Social proof = others adopted, so it's safer.
...
### Q20: **B.** Execs + affected internal customers first.
### Q21: **B.** Critical path = longest dependent sequence.
### Q22: **B.** Mentoring = long-term career.
### Q23: **B.** Transformational + cross-functional collaboration.
### Q24: **B.** Balanced KPI set.
### Q25: **B.** Senior exec with power AND interest.
### Q26: **B.** Decline + report accurately + escalate. No "smoothing over" audit findings.

---

## 📊 Score Yourself

- 24–26 → 🏆 Module 8 owned.
- 21–23 → ✅ Solid.
- 17–20 → ⚠️ Re-read Kotter, ADKAR, stakeholder analysis.
- <17 → 🔁 Restart Module 8.
...
- Kotter's 8 steps
- ADKAR
- Tuckman 5 stages + leader role at each
- RACI (A = only one)
- Power/Interest grid quadrants
- Cialdini's 6 principles
- Triple constraint + critical path
- PERT three-point formula
- Balanced KPI categories
- Spend Under Management world-class target

---

➡️ Next: [Cheat-Sheet.md](./Cheat-Sheet.md). Then **[Practice-Exam-2](../Practice-Exams/Practice-Exam-2.md)** (Modules 5–8), then **[Final-Mock-Exam](../Practice-Exams/Final-Mock-Exam.md)** under real conditions.
