...
### 1. The BEST definition of supply management is:
A. Issuing POs to selected vendors
B. Receiving and inspecting materials
C. Negotiating lowest unit price each year
D. Acquiring goods and services and managing the supply base to deliver value

### 2. Which is MOST strategic?
A. Expediting a late shipment
B. Updating an ERP record
C. Resolving an invoice dispute
D. Multi-year category strategy

### 3. A Center of Excellence in supply management primarily:
A. Provides methodology, tools, and analytics that enable other teams
B. Owns all spend
C. Replaces every category manager
D. Handles IT only
...
### 5. In Porter's value chain, procurement is classified as:
A. Primary activity
B. Logistics activity
C. Support activity
D. Marketing activity

### 6. A company with very diverse, unrelated business units is BEST served by:
A. Decentralized or hybrid with local autonomy
B. Fully centralized supply
C. Single global category manager
D. Outsource all sourcing

### 7. The 5-stage maturity model places "supply-enabled innovation drives revenue" at:
A. Stage 1
B. Stage 3
C. Outside the model
D. Stage 5 (world-class)

### 8. The classic Five Rights of supply management include all EXCEPT:
A. Right relationship
B. Right quantity
C. Right quality
D. Right time

### 9. Make-or-buy decisions should consider all EXCEPT:
A. Personal preference of the buyer
B. IP risk
C. Strategic importance
D. Internal capacity

### 10. The PRIMARY purpose of spend analysis is:
A. Identify suppliers to terminate
B. Audit AP
C. Calculate working capital
D. Provide visibility into historical spend

### 11. Direct spend includes:
A. Office supplies
B. Marketing services
C. Raw materials and components going into products
D. Travel

### 12. Indirect spend includes:
A. IT services, MRO, facilities
B. Production-line steel
C. Bill of materials components
D. Packaging in finished goods

### 13. A category in the LEVERAGE quadrant of Kraljic should use:
A. Long-term partnership
B. Inventory buffers
C. Single source
D. Competitive bidding / e-auctions to exploit buying power

### 14. A category in the STRATEGIC quadrant fits:
A. Catalog purchasing
B. Reverse auction
C. Multi-year partnership and joint development
D. Spot buying

### 15. A category in the BOTTLENECK quadrant should focus on:
A. Aggressive cost reduction
B. Ensuring supply via alternates, buffers, and long-term contracts
C. Reverse auctions
D. Brand-name specs

### 16. Single source differs from sole source in that:
A. They are identical
B. Single = a backup arrangement
C. Sole = best price
D. Single = we chose one of many; sole = only one supplier exists

### 17. Dual sourcing is BEST described as:
A. One supplier with two contracts
B. Two products from one supplier
C. Two suppliers, often with a primary/backup or 70/30 split
D. Two POs per quarter

### 18. The RFI is used to:
A. Award a contract
B. Sign an NDA
C. Compare firm price quotes
D. Learn about the market and capable suppliers

### 19. The RFP is BEST when:
A. The spec is fully defined and you need price
B. You only want to talk to one supplier
C. You're new to the market
D. You need a creative solution and best-value proposal

### 20. RFQ is BEST when:
A. Spec is vague
B. The spec is fully defined and price comparison is needed
C. You're considering a partnership
D. You want a relationship-driven dialogue

### 21. Reverse auctions work BEST for:
A. Strategic R&D services
B. Leverage-quadrant commodities with multiple qualified suppliers
C. Sole-source bottleneck items
D. Innovation-critical components

### 22. Maverick spend is:
A. Off-contract / unauthorized buying
B. Spend with diverse suppliers
...
B. After receiving proposals to fit them
...
A. Reduces the number of suppliers
B. Reduces variety of items
C. Increases inventory
D. Reduces SLAs

### 26. The bullwhip effect refers to:
A. Demand distortion amplifying upstream from end customer
B. Whips used in factories
...
B. Hiding forecasts
C. Erratic ordering
D. Sharing point-of-sale data with suppliers

### 28. Performance specifications are BEST when:
A. You want to micromanage design
B. Form must match exact assemblies
C. Brand name is required
D. You want supplier innovation

### 29. BATNA means:
A. Best Acceptable Terms for a Negotiated Agreement
B. Base Authority To Negotiate Agreement
...
A. A clause type
B. The opening offer
C. The overlap between buyer max and seller min
...
A. One-off commodity buys
B. Strategic long-term supplier relationships
C. Bottleneck-quadrant single sourcing
D. Tail-spend buys

### 33. A fixed-price contract places cost-overrun risk on the:
A. Supplier
B. Buyer
C. Insurance carrier
D. Lender

### 34. A cost-plus-fixed-fee contract places cost-overrun risk on the:
A. Both equally
B. Supplier
C. Buyer
D. Government

### 35. For an R&D engagement with uncertain scope, the BEST contract type is:
A. Cost-plus or T&M
B. Firm fixed-price
C. Take-or-pay
D. Brand-name fixed
...
### 36. UCC governs:
A. Services contracts only
B. US sale of goods
C. International sales between countries
D. US federal procurement

### 37. CISG applies by default when:
A. Buyer is in US and seller is in a signatory country, unless opted out
B. Both parties opt in
...
B. UCC fillers
C. Commercial goods only
D. US federal government contracts

### 39. Force majeure clauses typically excuse performance during:
A. Mild supply disruptions
B. Routine cost increases
C. Unforeseeable, unavoidable events like war or pandemic
D. Any supplier convenience

### 40. Termination for CONVENIENCE entitles the supplier to:
A. Nothing
B. Payment for work completed + reasonable wind-down costs
C. Punitive damages
D. Full remaining contract value

### 41. Termination for DEFAULT requires:
A. Buyer's wish to end
B. A material breach by the supplier
C. Mutual agreement
D. Force majeure

### 42. The Statute of Frauds under UCC requires a writing for sales of goods over:
A. $50
B. $100
C. $5,000
D. $500

### 43. An express warranty:
A. Is specifically stated by the seller
B. Is implied automatically under UCC
C. Cannot be disclaimed
D. Only applies to government contracts

### 44. An implied warranty of merchantability under UCC means goods are:
A. Fit for ordinary purpose
B. The best on the market
C. Free of all defects forever
D. Guaranteed lowest price

### 45. The dispute resolution ladder (typical) is:
A. Litigation first, then arbitration
B. Direct negotiation → mediation → arbitration → litigation
C. Force majeure first
D. Termination first

### 46. Mediation differs from arbitration in that:
A. Mediation is binding
B. Mediation is non-binding; arbitration is binding
C. They are identical
D. Mediation is for litigation only

### 47. An SLA without consequences (credits/penalties) is BEST described as:
A. Industry standard
...
A. Aggressive opening anchor
B. Small concessions sought at the end
C. Force majeure
D. Walking away

### 49. The MOST ETHICAL action when a supplier offers personal Super Bowl tickets during a contract renewal:
A. Decline + disclose + document per company policy
B. Accept; build the relationship
C. Accept and renegotiate harder
D. Accept and tell your boss later

### 50. SRM is BEST defined as:
A. Issuing POs
B. Paying suppliers timely
C. Annual price negotiation
D. Systematic management of supplier interactions to maximize value + minimize risk across lifecycle

### 51. Tier-1 strategic suppliers typically represent:
A. All suppliers
B. 50% of suppliers and 50% of spend
C. 1–5% of suppliers and 30–50% of spend
D. <1% of spend

### 52. A balanced supplier scorecard includes:
A. Only price
B. Quality, Cost, Delivery, Service (and often Innovation, ESG, Risk)
C. Only headcount
D. Only marketing metrics

### 53. The MOST appropriate response when a Tier-1 strategic supplier has a fixable capability gap:
A. Terminate immediately
B. Initiate supplier development
C. Cut volumes in half
D. Stop communication

### 54. A "QBR" stands for:
A. Quarterly Buyer Review
B. Quarterly Bonus Reconciliation
C. Quality Backlog Report
D. Quarterly Business Review

### 55. Which is a recognized US diverse-supplier category?
...
### 56. Tier-2 diversity reporting means:
A. Auditing financial tiers
B. Backup suppliers
C. Tracking diverse spend by your primary suppliers' subcontractors
D. Second-source sourcing

### 57. When NOT to invest in supplier development:
A. Strategic supplier with fixable gap
B. Willing, motivated supplier
C. Tier-3 supplier with fundamental gap and many alternatives
D. Positive ROI scenario

### 58. The MOST appropriate escalation step after a delivery issue persists at the daily contact level:
A. Escalate one level: category manager ↔ supplier sales director
B. Go directly to the supplier's CEO
C. Terminate immediately
D. Ignore it

### 59. With 4,800 active suppliers and 8 SRM staff, the BEST starting point is:
A. Audit all 4,800
B. Outsource SRM
C. Spend analysis and segmentation; deep SRM on Tier-1
D. Treat all identically

### 60. New supplier qualification typically includes:
A. No checks if pricing is great
B. Immediate strategic tier
C. First-article inspection + quality + financial audits
D. Daily POs only

### 61. PPM in supplier quality stands for:
A. Posts per Minute
B. Parts Per Million defects
C. Price per Module
D. Plan per Manager

### 62. The MOST ETHICAL action when a Tier-1 audit finds child labor:
A. Quietly switch suppliers
B. Ignore due to contract
C. Engage remediation per ISM principles, escalate, document, prepare contractual action up to termination
D. Cut volumes 10% silently

### 63. A scorecard's RED rating warrants:
A. Hope it improves
B. Unilateral price reduction
C. Immediate next-day switch with no plan
D. PIP + possible dual-sourcing in parallel
...
### 66. Tier-2 diversity reporting is REQUIRED by:
A. All global commercial contracts
B. Only IT firms
C. No one
D. Many US federal contracts and many large enterprise customers

### 67. Vested sourcing (Vitasek) emphasizes:
A. Win-lose
B. Outsource everything
C. Outcome-based, win-win with shared incentives
D. Lowest-price only

### 68. Exiting a strategic supplier should include:
A. Same-day termination
B. Structured transition with dual-sourcing for 6–12 months and knowledge transfer
C. Stop paying invoices
D. Refuse calls

### 69. The MOST important governance element for Tier-1 SRM:
A. Daily POs
B. Executive sponsorship + structured QBRs + clear escalation
C. Spot pricing
D. Catalog purchasing

### 70. Treating every supplier as "strategic":
A. Dilutes resources and confuses suppliers
B. Is CPSM best practice
C. Increases leverage
D. Reduces cost

### 71. A scenario: a sole-source supplier raises prices 25% knowing you have no alternative. The BEST long-term response is:
A. Develop alternate source, design around the part, multi-year contract, explore make-or-buy
B. Pay and move on
C. Litigate immediately
D. Stop production

### 72. The 7-step strategic sourcing process begins with:
A. Negotiation
B. Profile category + internal demand
C. Awarding
D. Implementation

### 73. The MOST ETHICAL action when an internal customer pressures supply to skip standard qualification for a personal friend's company:
A. Decline, explain the policy and risk, escalate if pressured further, document
B. Skip to maintain harmony
C. Skip but document
D. Redirect the friend elsewhere

### 74. The MOST appropriate response when a sourcing manager realizes she would benefit personally from an award decision:
A. Continue without disclosure
B. Resign
C. Award to the conflicted party
D. Recuse herself, disclose the conflict of interest, transfer the decision

### 75. Performance specifications differ from design specifications in that:
A. They are stricter
B. They tell suppliers what to deliver, not how
C. They are required by UCC
D. They forbid innovation

### 76. The BEST first step when a sourcing analyst inherits a category with no documentation:
A. Issue an RFQ
B. Award to incumbent
C. Run a spend analysis to understand current state
D. Cancel all contracts

### 77. A contract clause that allocates third-party liability is:
A. Limitation of liability
B. Warranty
C. Indemnification
D. Force majeure

### 78. The MOST ethical action when a supplier provides confidential competitor information:
A. Refuse, return/destroy the info, document, remind supplier of confidentiality obligations
B. Use it
C. Share with management only
D. File for future reference

### 79. A scenario: scope is undefined and the supplier proposes T&M; the CFO insists on fixed-price for budget certainty. The BEST response is:
A. Sign fixed-price; safer
B. Sign T&M without telling the CFO
C. Refuse to engage
D. Explain dispute risk; propose phased: T&M for discovery, fixed-price once scope is clear

### 80. A scenario: an internal stakeholder asks you to backdate a PO to fit prior-quarter budget. The BEST action is:
A. Backdate; budgets matter
B. Resign
C. Backdate and inform finance later
D. Decline; explain finance/audit policy; escalate
...
```
1. D    11. C    21. B    31. B    41. B    51. C    61. B    71. A
2. D    12. A    22. A    32. B    42. D    52. B    62. C    72. B
3. A    13. D    23. A    33. A    43. A    53. B    63. D    73. A
4. D    14. C    24. C    34. C    44. A    54. D    64. B    74. D
5. C    15. B    25. A    35. A    45. B    55. D    65. B    75. B
6. A    16. D    26. A    36. B    46. B    56. C    66. D    76. C
7. D    17. C    27. D    37. A    47. B    57. C    67. C    77. C
8. A    18. D    28. D    38. D    48. B    58. A    68. B    78. A
9. A    19. D    29. C    39. C    49. A    59. C    69. B    79. D
10. D   20. B    30. C    40. B    50. D    60. C    70. A    80. D
```
...
| Score | Verdict |
|-------|---------|
| 72–80 | 🏆 Strong foundation; proceed to Modules 5–8 with confidence |
| 60–71 | ✅ Solid; review wrong answers before Practice Exam 2 |
| 50–59 | ⚠️ Re-read weak modules; redo this exam in 1 week |
| <50 | 🔁 Restart from Module 1 |
