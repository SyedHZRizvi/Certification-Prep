...
# 🎥 Module 7 Videos: Production Activity Control

> **How to use:** Sequence-rule videos are best watched with a notepad. Re-do the SPT/EDD comparisons by hand.
...
<div class="vg-grid" markdown="0">
  ...
  <a class="vg-card" data-video-id="YwqUoRe0Ms4" href="https://www.youtube.com/results?search_query=Critical+Ratio+CR+priority+sequencing" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">Critical Ratio Sequencing</p>
  ...
  <a class="vg-card" data-video-id="rvxbA0JiHVQ" href="https://www.youtube.com/results?search_query=Shop+floor+control+production+activity+control" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">Shop Floor Control Overview</p>
      <p class="vg-creator">MIT OCW Operations Management</p>
      <span class="vg-duration">⏱ 16 min · The execution layer</span>
    </div>
  </a>
</div>
...
<div class="vg-grid" markdown="0">
  <a class="vg-card" data-video-id="u38l1tV5lkc" href="https://www.youtube.com/results?search_query=Manufacturing+cell+group+technology+layout" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      ...
      <p class="vg-title">Manufacturing Cells &amp; Group Technology</p>
  ...
  <a class="vg-card" data-video-id="BtbuShkGj4I" href="https://www.youtube.com/results?search_query=Gantt+chart+scheduling+production" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag recommended">Recommended</span>
      <p class="vg-title">Gantt Charts for Production Scheduling</p>
      <p class="vg-creator">Education Edge</p>
  ...
  <a class="vg-card" data-video-id="3kremrFIGPo" href="https://www.youtube.com/results?search_query=Push+vs+Pull+manufacturing+system" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag recommended">Recommended</span>
      <p class="vg-title">Push vs Pull Manufacturing</p>
      <p class="vg-creator">freeCodeCamp Manufacturing</p>
      <span class="vg-duration">⏱ 10 min · MRP vs kanban execution</span>
    </div>
  </a>
</div>
...
<div class="vg-grid" markdown="0">
  <a class="vg-card" data-video-id="Kk5zhoRA1Uc" href="https://www.youtube.com/results?search_query=Johnson+rule+two+machine+scheduling" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      ...
      <p class="vg-title">Johnson's Rule (Two-Machine Sequencing)</p>
  ...
  <a class="vg-card" data-video-id="c5HNkn6ZibY" href="https://www.youtube.com/results?search_query=Factory+Physics+little+law+WIP" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag optional">Optional</span>
      <p class="vg-title">Factory Physics &amp; Little's Law</p>
      <p class="vg-creator">Caltech</p>
  ...
  <a class="vg-card" data-video-id="lRHl1zTxMRQ" href="https://www.youtube.com/results?search_query=Manufacturing+execution+system+MES+shop+floor" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag optional">Optional</span>
      <p class="vg-title">Manufacturing Execution Systems (MES)</p>
      <p class="vg-creator">freeCodeCamp Manufacturing</p>
      <span class="vg-duration">⏱ 18 min · Software for PAC</span>
    </div>
  </a>
</div>
...
|---------|-----|
| **ASCM** | Official |
| **Education Edge** | Sequence-rule worked examples |
| **GreyCampus** | CPIM-style practice |
| **MIT OCW Operations Management** | Theory + Johnson's rule |
| **Caltech** | Factory physics, Little's Law |

---

## ✅ After watching

1. Name the 5 elements of manufacturing lead time.
2. Which element typically dominates LT?
3. Sequence 3 jobs (A=5d, B=2d, C=4d) by SPT. Compute average flow time.
4. Critical Ratio formula?
5. Difference between push and pull?
