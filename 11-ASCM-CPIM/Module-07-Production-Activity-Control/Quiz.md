...
### Q1. Production Activity Control is the:
A. Long-range S&OP layer
B. Component planning layer (MRP)
C. Execution / shop-floor layer
D. Strategic plan

### Q2. Manufacturing lead time consists of 5 elements. Which is NOT one of them?
A. Queue
B. Setup
C. Run
D. Marketing

### Q3. In typical manufacturing lead time, the dominant element is:
A. Setup
B. Run
C. Queue
D. Move

### Q4. The difference between *queue* and *wait* time is:
...
### Q5. The dispatching rule that minimizes average flow time on a single machine is:
A. FCFS
B. SPT
C. EDD
D. LPT

### Q6. The dispatching rule that BEST minimizes maximum tardiness is:
A. FCFS
B. SPT
C. EDD
D. LPT
...
### Q9. Three jobs at one work center (FCFS arrival): A=4d, B=2d, C=6d. Under FCFS, average flow time =
A. 4
B. 6
C. 7.33
D. 12

### Q10. Same jobs (A=4, B=2, C=6) sequenced by SPT, average flow time =
A. 4.0
B. 5.33
C. 6.0
D. 12

### Q11. A dispatch list is:
...
### Q14. The PRIMARY benefit of converting a job-shop area into a manufacturing cell is:
A. Higher wages
B. Reduced setup, material handling, and queue time for that part family
C. Eliminated capacity needs
D. Removed safety stock

### Q15. SMED (Single Minute Exchange of Die) aims to:
...
### Q16. The first step of SMED is to:
...
### Q17. A PULL system is triggered by:
A. A forecast
B. Actual downstream demand or consumption
C. The CEO
D. The supplier

### Q18. A PUSH system in a manufacturing context is BEST described as:
A. Demand-driven
B. Schedule-driven (MRP releases work based on plan)
C. Visual signals only
D. Random release

### Q19. Input/Output Control reports show:
A. Cash flow
B. Planned vs actual work released and completed at each work center over time
C. Customer satisfaction
D. Inventory turnover

### Q20. A growing queue at a work center over consecutive weeks signals:
...
### Q21. A bottleneck work center in a PAC context should:
...
### Q22. Average flow time vs makespan: which is the time from first job start to last job finish?
A. Flow time
B. Average flow time
C. Makespan
D. Tardiness
...
### Q24. SPT optimizes mean flow time on:
