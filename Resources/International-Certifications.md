---
permalink: /Resources/International-Certifications/
...
- **Fee:** **$200 USD** (one-time; lifetime credential).
- **Eligibility:** None. Anyone can sit the exam.
- **How to register / sit for the exam:**
  1. Create an account at [scrum.org/professional-scrum-master-i-certification](https://www.scrum.org/professional-scrum-master-i-certification)
  2. Pay $200 via credit card
  3. Receive your unique exam password by email
...
- **Issuing body:** **Scrum Alliance** (older, broader organization).
...
- **How to register / sit for the exam:**
  ...
  3. Complete the 2 days of training
  4. Trainer gives you exam access within ~7 days
  5. Take the online 50-question exam (2 attempts within 90 days, free)
  6. Pass mark: 74% (37/50). Result is instant.
- **Renewal:** Every 2 years · 20 SEUs (Scrum Education Units) + $100 renewal fee.
...
- **Fee:** **$405 USD (PMI member) / $555 USD (non-member).** Annual PMI membership is $139, so membership is worth it for the discount + free PMBOK access.
- **Eligibility:**
  - 36 months of PM experience (with 4-year degree) OR 60 months (with high-school / associate's degree)
  - **35 hours of project management education** (this course gives you the substance; document it carefully)
- **How to register / sit for the exam:**
  1. Create an account at [pmi.org](https://www.pmi.org/)
  2. (Optional but smart) Pay the $139 PMI membership first
...
- **Issuing body:** PMI.
- **Market standing:** Tier-2 entry-level PM cert. Great career-launcher if you don't yet have the PMP experience requirement.
- **Benefits of passing:** Demonstrates PM knowledge to hiring managers, qualifies you for junior PM roles ($55K-$80K) while you accumulate the experience for PMP.
...
- **Fee:** **$100 USD.** (Often $50 with a re:Invent voucher; AWS frequently offers 50%-off vouchers post-event.)
- **Eligibility:** None.
- **How to register / sit for the exam:**
  ...
  5. Take the 90-minute exam
  6. Score appears on screen at the end; digital badge issued via Credly within 5 business days
- **Renewal:** **Every 3 years** · re-pass the same exam OR pass a higher-tier exam (SAA, etc.) which automatically renews CLF.
...
- **Fee:** **$150 USD.**
- **Eligibility:** None (1+ year of hands-on AWS strongly recommended; this course supplies the equivalent knowledge).
- **How to register:** Same flow as CLF-C02 via aws.amazon.com/certification → pay → Pearson VUE / PSI scheduling.
...
**Designation earned after passing:** *Microsoft Certified: Azure Administrator Associate*

- **Issuing body:** Microsoft.
- **Market standing:** Tier-1 flagship Associate. Foundation for nearly every Azure-focused engineering role.
...
- **Fee:** **$1,295 (ASCM member) / $1,795 (non-member)** for exam only. With official Learning System: **$2,595 / $3,495**.
- **Eligibility:** Bachelor's degree + 2 years SCM experience, OR APICS CPIM/CLTD, OR 5 years SCM experience (no degree needed).
- **How to register:**
  1. Create an account at [ascm.org](https://www.ascm.org/)
  2. Apply for CSCP eligibility (submit work history)
  3. Pay the exam fee
...
**Designation earned after passing:** *Certified in Logistics, Transportation & Distribution (CLTD)*

- **Issuing body:** ASCM.
- **Market standing:** Tier-1 logistics-focused credential.
- **Benefits of passing:** Required or preferred for Logistics Manager, Distribution Manager, Transportation Manager, and Fulfillment Operations roles. Average CLTD-holder salary $80K-$110K.
- **Exam format:** 150 questions · 3.5 hours.
- **Fee:** **$1,295 (member) / $1,795** exam-only. Bundle: **$2,595 / $3,495**.
- **Eligibility:** None for the exam.
- **How to register:** Same as CSCP via ascm.org.
- **Renewal:** Every 5 years.
...
- **Fee:** **$199 (member) / $299 (non-member) per exam.** Three exams total = $597 (member) / $897 (non-member).
- **Eligibility:** Bachelor's degree + 3 years supply-management experience, OR 5 years experience without a degree.
- **How to register:**
  1. Create an account at [ismworld.org](https://www.ismworld.org/)
  2. Apply for CPSM eligibility (submit work history)
  3. Pay for one exam at a time (no requirement to schedule all three at once)
  4. Schedule via Prometric
  5. Take each 2.5-hour exam
- **Renewal:** Every 3 years · 60 CEHs (Continuing Education Hours).
...
### ➡️ HubSpot Content Marketing Certification (FREE)

Same flow, complementary certification on content strategy + production.
...
- **Benefits of passing:** Required or preferred for Performance Marketing, PPC Specialist, Paid Search Manager, and Performance Media Buyer roles. Multiple specializations stack on your profile.
- **Exam format:** ~50 questions each specialization · ~75 minutes · 80% pass.
- **Fee:** **FREE.**
- **How to register:** Create account at [skillshop.exceedlms.com](https://skillshop.exceedlms.com/) → enroll → take exam online (no proctor).
- **Renewal:** Every 1 year (free re-take per cert).

### ➡️ Meta Blueprint Certifications

- **Issuing body:** Meta.
- **Fee:** **$99-$150 per exam** (recently moved from free).
- **How to register:** [facebookblueprint.com](https://www.facebookblueprint.com/) → buy exam → take via Pearson VUE.
- **Renewal:** 1 year.
...
- **Issuing body:** Google Skillshop.
- **Market standing:** Tier-2 measurement credential. Required for many analytics-titled roles.
- **Fee:** **FREE.**
- **Renewal:** Every 1 year (free re-take).
...
This course produces a **portfolio** that wins clients and jobs. Pair it with:

### ➡️ DMI Professional Diploma in eCommerce Marketing
...
- **How to register:** [digitalmarketinginstitute.com](https://digitalmarketinginstitute.com/) → enroll → complete coursework → take final exam.
- **Renewal:** Every 2 years (modest CPD requirement).
...
- **Eligibility:** None.
- **How to register:**
  1. Create an account at [cryptoconsortium.org/exams/cbp](https://cryptoconsortium.org/exams/cbp/)
  2. Pay $150
...
- **Fee:** **$300 USD.**
- **How to register:** [blockchaintrainingalliance.com](https://blockchaintrainingalliance.com/) → buy exam → take via Pearson VUE.
- **Renewal:** Every 3 years.

### ➡️ Cryptoasset Anti-Financial Crime Specialist (CCAS)
...
- **Exam format:** 50 questions · 100 minutes · proctored.
- **Fee:** **$225 USD.**
- **How to register:** [helpx.adobe.com/certification](https://helpx.adobe.com/certification.html) → choose Adobe Commerce Business Practitioner → schedule via Pearson VUE.
- **Renewal:** Adobe product cycle (typically 2 years).

### ➡️ Salesforce B2C Commerce Cloud Developer / Architect

**Designation earned after passing:** *Salesforce B2C Commerce Cloud Developer* (or Architect)

- **Issuing body:** Salesforce.
- **Market standing:** Tier-1 for enterprise retail. **Highest-paying e-commerce certifications in the US** (~$165K average for Architect).
...
| CPSM | CIPS · MCIPS |
| HubSpot Inbound | Google Ads Search · Meta Blueprint · HubSpot Content Marketing |
| Google Ads Shopping | Meta Blueprint Commerce · Amazon Ads |
| GA4 IQ | CXL Measurement & Analytics |
| CBP | CBSA · CCAS · UNIC MSc |
| Adobe Commerce BP | Adobe Commerce Developer · Salesforce B2C |
...
## 📜 Renewal Tracker (Quick Reference)

| Cert family | Renewal cycle | Notes |
|-------------|---------------|-------|
| PMI (PMP, PMI-ACP, PgMP) | 3 years · 60 PDUs | $150 renewal fee |
...
| ISACA (CISM, CISA) | 3 years · 120 CPEs + $45/yr AMF | |
| **C4 (CBP)** | **Lifetime** | |
| BTA (CBSA, CBD) | 3 years · Re-exam | |
| **Coursera-hosted (Wharton, Google D-M & E-C)** | **Lifetime** | |
| Vendor marketing (HubSpot, Google Ads, Meta) | 1 year · Free retake | |
