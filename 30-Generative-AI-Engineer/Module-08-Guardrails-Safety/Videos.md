...
# 🎥 Module 8 Videos: Guardrails & Safety
...
| Channel | Why |
|---------|-----|
| **Simon Willison** | The leading voice on practical prompt injection |
| **NVIDIA Developer** | NeMo Guardrails official content |
| **Anthropic / OpenAI safety teams** | The frontier labs' published thinking |
| **OWASP** | The community standard for LLM security |
| **Embrace The Red (Johann Rehberger)** | Real-world prompt-injection bug bounties |
