---
permalink: /36-3D-Animation-Blender/Module-04-Lighting-HDRI/Videos/
title: "Module 4 Videos: Lighting & HDRI"
---

# 🎬 Module 4 Videos: Lighting & HDRI
...
<a class="vg-card" data-video-id="ENnEYoUpFfU" href="https://www.youtube.com/results?search_query=Blender+lighting+tutorial+three+point+lighting+character" target="_blank" rel="noopener">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
    <div class="vg-card-title">Blender Lighting Tutorial — Three-Point Lighting for Characters</div>
    <div class="vg-card-meta">Blender Guru · ~40 min</div>
    <div class="vg-card-desc">Andrew Price's three-point lighting tutorial adapted for Blender 4.x. Key/fill/rim ratios, Area light setup, and the key-to-fill ratio's effect on mood.</div>
  </div>
</a>
