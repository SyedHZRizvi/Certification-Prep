---
permalink: /36-3D-Animation-Blender/Module-02-3D-Modeling/Videos/
title: "Module 2 Videos: 3D Modeling for Animation"
---

# 🎬 Module 2 Videos: 3D Modeling for Animation
...
<a class="vg-card" data-video-id="z-Xl9tGqH14" href="https://www.youtube.com/results?search_query=Blender+low+poly+character+modeling+tutorial+beginner+topology" target="_blank" rel="noopener">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Grant Abbitt · ~60 min</div>
    <div class="vg-card-desc">Grant Abbitt's definitive low-poly character workflow. Covers block-out, Mirror Modifier, limb construction, and basic hand topology. Most-referenced tutorial for this module.</div>
  </div>
</a>
...
<a class="vg-card" data-video-id="9OA2asQdi_U" href="https://www.youtube.com/results?search_query=Blender+proportional+editing+tutorial+organic+modeling" target="_blank" rel="noopener">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-desc">Falloff types, radius control with scroll wheel, and practical uses for character body reshaping without sculpting tools.</div>
  </div>
</a>
