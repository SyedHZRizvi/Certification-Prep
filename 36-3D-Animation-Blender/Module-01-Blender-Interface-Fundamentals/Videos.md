---
permalink: /36-3D-Animation-Blender/Module-01-Blender-Interface-Fundamentals/Videos/
title: "Module 1 Videos: Blender Interface & Fundamentals"
---
...
## 🔴 Essential (Watch Before Starting Module 2)
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=Blender+viewport+shading+modes+explained+solid+material+rendered" data-video-id="3p7NfwrUKuY" target="_blank" rel="noopener">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-desc">Solid, Material Preview, Rendered, and Wireframe modes demonstrated with practical use-case examples. Includes the Z pie menu workflow.</div>
  </div>
</a>
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=Blender+4+new+features+interface+improvements+2024" data-video-id="8_V4d1tCXLQ" target="_blank" rel="noopener">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-desc">What changed in Blender 4.0, 4.1, and 4.2 that affects the interface and default settings. Covers Bone Collections replacing bone layers, and the Asset Library improvements.</div>
  </div>
</a>
