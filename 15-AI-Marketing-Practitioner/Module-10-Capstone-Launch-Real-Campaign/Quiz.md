...
### Q1. The capstone budget split is: *(Remember)*
A. $200 Google, $0 Meta
B. $100 Google Search, $100 Meta Reels
C. $50 across all channels
D. $1,000 split 4 ways
...
### Q3. The minimum runtime for the capstone is: *(Remember)*
A. 3 days
B. 7 days
C. 14-21 days
D. 60 days
...
### Q5. Day 1 of the capstone, the FIRST thing you should produce is: *(Apply)*
A. Ad creative
B. The campaign brief (using Module 1's template)
C. Landing page
D. Budget allocation
...
### Q7. The daily ops routine takes approximately: *(Remember)*
A. 5 minutes
B. 15 minutes
C. 2 hours
D. 8 hours
...
### Q8. If your CPA is above target on Day 7, the recommended action is: *(Analyze)*
A. Immediately pause everything
B. Double the budget
C. Diagnose: check search terms (Google), check creative breakdown (Meta), adjust accordingly
D. Wait 30 more days

---

### Q9. The grading rubric has how many dimensions? *(Remember)*
A. 3
B. 8 (Brief, Tracking, Creative, Structure, Launch, Optimization, Measurement, Post-Mortem)
C. 20
D. 100

---

### Q10. The 4 capstone deliverables are: *(Remember)*
A. Just the campaign data
B. Brief + Daily Log + Final Report + Blog Post
C. 50 ad variations
D. A 10-page PDF

---

### Q11. The "What I'd Do With $1,000" follow-up section is: *(Understand)*
A. Required
B. Recommended for portfolio-grade capstones (above minimum viable)
C. Forbidden
D. Only for B2B
...
### Q14. The minimum daily budget per channel during launch week is approximately: *(Apply)*
A. $0.50
B. $7/day (sufficient for Smart Bidding to learn)
C. $100/day
D. $1,000/day

---

### Q15. The "Out of Scope" line in the capstone brief exists to: *(Understand)*
A. List rejected creative
B. Document what the campaign is explicitly NOT trying to do, preventing scope creep
C. Hide weaknesses
D. List vendors not used
...
### Q17. The capstone's "Lessons Learned blog post" should be: *(Create)*
A. 500 words and generic
B. 1,500-2,000 words with real numbers, honest assessment, and forward-looking lessons
C. 10,000 words
D. Just a Twitter thread
...
### Q19. The "Insight" line in the capstone brief should be: *(Understand)*
A. A feature
B. A benefit
C. A non-obvious behavioral truth about your customer
...
### Q21. A guardrail KPI is: *(Remember)*
A. The metric you most want to hit
B. The pause-trigger metric ("Stop if CPA > $15 for 2 consecutive days")
C. The same as primary KPI
D. Optional
...
### Q23. Portfolio-grade capstones (vs minimum viable) typically include: *(Create)*
A. The same outputs
B. Plus: a follow-up "What I'd do with $1,000" + a video walkthrough + a deck for hiring conversations
C. Less work
D. Just a longer report

---

### Q24. The single most important reason to do the capstone (vs skipping it) is: *(Evaluate)*
A. Saving money
B. You cannot truly learn marketing without running real campaigns with real money and writing honestly about what happened
...
Brief first. Everything else flows from it. Without a brief, your campaign drifts within 48 hours.

### Q6: **B. Pixel + CAPI + Domain Verification + AEM events + GA4 conversion import**
The full defensive tracking stack. Without it, your data is broken from minute one.

### Q7: **B. 15 minutes**
Per the daily ops routine: 5 min Google, 5 min Meta, 5 min conversion check.

### Q8: **C. Diagnose**
Check what's actually wrong before changing strategy. Maybe the issue is creative (CTR), maybe audience (CPM), maybe landing page (CR). Diagnose before reacting.

### Q9: **B. 8 dimensions**
The 8 rubric dimensions: Brief Quality, Tracking, Creative, Structure, Launch, Optimization, Measurement, Post-Mortem. Each scored out of 10-15 for 100 total.

### Q10: **B. Brief + Daily Log + Final Report + Blog Post**
...
### Q14: **B. $7/day**
$7/day = $200/month on each channel. Enough for Smart Bidding and Meta learning to function. Below this, neither platform's algorithms work.
...
- 22-24/24 → 🏆 You're process-ready. **GO LAUNCH.**
- 19-21/24 → ✅ Solid. Re-skim the rubric and daily ops.
- 15-18/24 → ⚠️ Re-read Module 10 fully before launching.
- < 15/24 → 🔁 Restart Module 10.
...
➡️ Next: [Cheat-Sheet.md](./Cheat-Sheet.md), then [Final Mock Exam](../Practice-Exams/Final-Mock-Exam.md), then **GO LAUNCH YOUR REAL CAPSTONE**.
