...
- Configure programmatic retargeting through DV360, AdRoll, or Criteo
...
|---|--------|------|--------------------|
| 1 | [Campaign Strategy & Brief Writing](./Module-01-Campaign-Strategy-Brief-Writing/Reading.md) | 3 hrs | The brief (creative + media), ICP validation, AI-assisted briefing |
| 2 | [Google Ads Search Mastery](./Module-02-Google-Ads-Search-Mastery/Reading.md) | 5 hrs | Account structure, match types in 2026, Smart Bidding, $200 walkthrough |
...
| 10 | [Capstone: Launch a Real Campaign](./Module-10-Capstone-Launch-Real-Campaign/Reading.md) | 8 hrs | $200 budget across Google + Meta, daily ops, post-mortem, portfolio piece |

**Total study time:** ~44 hours of reading + 14 hours of videos + 12 hours of quizzes + 8 hours of capstone hands-on = **~78 hours**
...
|------|-----------------|--------|------------|
| Practice-Exam-1 | After Modules 1–5 | 40 Q / 60 min | ⭐⭐⭐ |
...
|-----------|-------------|--------|------------------|
| Google Ads Search Certification | Free | 50 Q / 75 min · 80% pass | [skillshop.exceedlms.com](https://skillshop.exceedlms.com/) |
...
```
Week 1: Module 1 (Brief Writing) + Module 2 (Google Search) → spend $20 on test campaign
Week 2: Module 3 (PMax/Video) + Module 4 (Meta Ads) → set up Pixel + CAPI
Week 3: Module 5 (TikTok/LinkedIn) + Practice Exam 1
Week 4: Module 6 (Programmatic) + Module 7 (CRO) → run 1 landing page test
Week 5: Module 8 (AI Content) + Module 9 (Automation) → Practice Exam 2
Week 6: Module 10 Capstone (run real $200 campaign) + Final Mock → take Google Ads Search Cert
```
...
| Personalization | Mutiny, Dynamic Yield, Optimizely Personalization, Unbounce Smart Traffic |
...
|------|------|
| This course | Free |
| Capstone ad spend (Module 10) | $200 (split Google + Meta) |
| Optional: Meta MBP exam | $150 |
| Optional: Midjourney / Runway subscriptions during course | ~$30–60/mo |

**Minimum:** $0 if you skip the capstone and exams. **Recommended:** $200 capstone + $150 Meta exam = **$350 total**.

---

## 🎬 Start Here

👉 [**Module 1: Campaign Strategy & Brief Writing**](./Module-01-Campaign-Strategy-Brief-Writing/Reading.md)

Real budgets. Real campaigns. Real results. Let's launch something. 🚀
