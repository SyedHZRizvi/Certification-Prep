...
> - Cross-course: [`04-AWS-Solutions-Architect-Associate` Module 4](../../04-AWS-Solutions-Architect-Associate/Module-04-Compute/Reading.md) covers EC2 / ASG / placement groups — the AWS analogue; [`09-CompTIA-Security-Plus`](../../09-CompTIA-Security-Plus/) covers VM encryption (ADE) as a control class.
