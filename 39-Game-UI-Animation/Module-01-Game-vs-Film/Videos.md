---
title: "Module 1 Videos: Game vs. Film Animation"
---
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=GDC+game+animation+design+principles+real+time" data-video-id="">
  <div class="vg-card-thumb">🎮</div>
  <div class="vg-card-body">
    <div class="vg-card-title">GDC: Game Animation Design Principles for Real-Time</div>
    <div class="vg-card-sub">Game Developer Conference · 30–50 min</div>
    <p>GDC Animation Summit talk covering the foundational differences between film and game animation workflows, state machines, and the 60fps constraint.</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=game+feel+animation+hit+stop+squash+stretch+explained" data-video-id="">
  <div class="vg-card-thumb">🎯</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=game+animation+normal+map+baking+LOD+performance+explained" data-video-id="">
  <div class="vg-card-thumb">🗜️</div>
  <div class="vg-card-body">
    <div class="vg-card-title">Normal Map Baking, LOD & Animation Compression for Games</div>
    <div class="vg-card-sub">Various · 20–30 min</div>
    <p>How normal maps, LOD meshes, and animation compression work together to make game characters look detailed while staying within the runtime performance budget.</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=Naughty+Dog+Last+of+Us+animation+system+GDC+SIGGRAPH" data-video-id="">
  <div class="vg-card-thumb">🎭</div>
  <div class="vg-card-body">
    <div class="vg-card-title">Naughty Dog: Last of Us Animation System Deep Dive</div>
    <div class="vg-card-sub">GDC / SIGGRAPH · 45 min</div>
    <p>Technical talk from Naughty Dog's animation team on the proprietary state machine and blend system that powers Ellie and Joel's expressive, responsive movement.</p>
  </div>
</a>
