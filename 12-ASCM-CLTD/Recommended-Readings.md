...
>
> Each entry includes (a) why it matters and (b) when in the course you should engage with it.

---

## 🧱 Canonical Textbooks (5)

### 1. Christopher, Martin. *Logistics & Supply Chain Management.* 5th ed. Pearson / FT Publishing, 2016. ISBN 978-1292083797.
**Why it's worth your time.** The most widely-taught logistics text in MBA programs globally (Cambridge, INSEAD, Cranfield). Christopher introduced the *agility / responsiveness* framing that Hau Lee later expanded into Triple-A. Strong on demand-driven logistics, postponement, and time compression.
**When to engage.** Read Chapter 1 alongside Module 1 of this course; Chapters 3, 4, 6 alongside Modules 2, 4, 6. Save Chapter 11 (sustainability) for Module 8.
...
**Why it's worth your time.** The single best practitioner book on warehouse operations. Frazelle (CEO of Logistics Resources International, professor at Georgia Tech) is the field's most influential warehouse-design consultant. Includes the original slotting math and the layout-optimization frameworks that CLTD Module 5 summarizes.
**When to engage.** Read selectively during Module 5; revisit when planning the Capstone DC consolidation.

### 5. Tompkins, James A., White, John A., Bozer, Yavuz A., & Tanchoco, J.M.A. *Facilities Planning.* 4th ed. John Wiley & Sons, 2010. ISBN 978-0470444047.
**Why it's worth your time.** The IE / facilities-engineering reference. Heavier math than Frazelle. Tompkins's MILP and SLP (Systematic Layout Planning) methods underpin every modern network-design tool (Coupa, OptiLogic, AnyLogic).
**When to engage.** Reference during Module 1 (network design) and Module 5 (layout). Skim, don't read cover-to-cover.
...
**Why it's worth your time.** Hau Lee (Stanford GSB) defines **Agility, Adaptability, Alignment** as the three durable sources of supply-chain competitive advantage. Cited in essentially every modern CSCMP and ASCM publication. The CLTD body of knowledge implicitly references all three.
...
**Why it's worth your time.** The single most-cited US logistics industry data source. Tracks US business logistics costs (~$2.3T in 2023, ~8.7% of US GDP), modal share, e-commerce impact, labor trends. New each June. Free 2-page summary; full report available to CSCMP members or for purchase.
**When to engage.** Module 6 (transportation modal economics) and the Capstone (industry benchmarks).

### 6. Smart Freight Centre. *Global Logistics Emissions Council (GLEC) Framework v3.0.* Smart Freight Centre, Amsterdam, 2023.
**Why it's worth your time.** The industry-standard methodology for calculating logistics emissions per ton-km by mode. Used by major shippers and carriers globally (Maersk, DHL, UPS, FedEx use GLEC factors in customer-facing emissions reports). The CLTD body of knowledge references it directly in Module 8.
...
**Why it's worth your time.** The canonical historical narrative of how Malcom McLean's 1956 container invention transformed global logistics. Essential context for Module 6 (ocean) and Module 7 (global trade). Levinson is a Forbes / WSJ logistics columnist; the book reads like prestige journalism.
**When to engage.** Read during Module 6 or 7.

---

## 📰 Industry Resources (5)

### 1. CSCMP Quarterly + Council of Supply Chain Management Professionals events.
**Why subscribe.** Quarterly research papers, annual EDGE conference (the largest logistics conference in North America, ~3,000 attendees). The CLTD Learning System draws heavily here.
...
**Why subscribe.** The Bloomberg Terminal of US trucking and freight. Daily SONAR market data, breaking-news on carrier moves (Yellow's bankruptcy, FedEx Ground network consolidation, electric truck deployment). Free newsletter; SONAR data paid.
...
**Why subscribe.** Global ocean / air / freight forwarder news. UK-based, multinational coverage. Best free source for ocean-rate movements, container-alliance reshuffles (2024 2M dissolution → 2025 Gemini Cooperation), Red Sea crisis updates.
**When to engage.** Continuous during Modules 6 and 7.
...
- **McDonough, William, & Braungart, Michael.** *Cradle to Cradle: Remaking the Way We Make Things.* North Point Press, 2002. ISBN 978-0865475878. The originating manifesto of the circular economy. Module 8 cites this implicitly throughout.
- **Martin, André J.** *Distribution Resource Planning.* 3rd ed. John Wiley & Sons, 1995. ISBN 978-0471132226. The original DRP textbook. Now dated, but reading the original gives you the intellectual lineage of every modern DRP/MEIO tool.

---

## How to use this list

- **Before the CLTD exam:** Skim Christopher Ch. 1, Coyle Ch. 7, Frazelle Ch. 1, Lee 1997 (bullwhip), Lee 2004 (Triple-A), GLEC v3.0 Ch. 1–2. That's roughly 50 hours of reading, distributed over your 12-week study plan.
- **During the Capstone:** Use Bowersox/Closs/Cooper Ch. 7+11, the CSCMP State of Logistics Report, and Gartner's TMS Magic Quadrant as primary reference.
- **After the CLTD exam:** MIT MicroMasters is the next step. Then SCPro Level 2 (CSCMP) or pursue CSCP / CPIM / CPSM in the ASCM family for breadth.

> A CLTD candidate who has read the canonical textbooks, the seminal HBR/Sloan papers, and follows FreightWaves + The Loadstar + Gartner is meaningfully ahead of a candidate who only used the Learning System. That depth is what gets you to Director level, not just certified.
