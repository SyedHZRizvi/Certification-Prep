---
permalink: /34-2D-Digital-Animation/Module-10-Production-Pipeline/Videos/
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=2D+animation+studio+production+pipeline+explained+storyboard+layout" data-video-id="D7Ox60i0JPk" target="_blank">
    <strong>The 2D Animation Production Pipeline, From Storyboard to Delivery</strong><br>
    <em>Eric Bravo</em> · ~30 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=Toon+Boom+Harmony+vs+Adobe+Animate+comparison+2024" data-video-id="J8gELvso_pw" target="_blank">
    <strong>Toon Boom Harmony vs Adobe Animate, Which Is Right for Your Production?</strong><br>
    <em>InspirationTuts 2D</em> · ~22 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=animatic+storyboard+animation+tutorial+how+to+make" data-video-id="-I05ICuSc9w" target="_blank">
    <strong>How to Make an Animatic, Storyboard to Moving Panels</strong><br>
    <em>TipTut</em> · ~25 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=2D+animation+compositing+After+Effects+character+background" data-video-id="FD67xHQ__fM" target="_blank">
    <strong>2D Animation Compositing in After Effects, Characters, Backgrounds, and Effects</strong><br>
    <em>Base14Productions</em> · ~28 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=Simpsons+Rick+Morty+Toon+Boom+Harmony+animation+pipeline" data-video-id="k3V9d_NMFU4" target="_blank">
    <strong>Inside the Studio Pipeline, The Simpsons and Rick and Morty</strong><br>
    <em>Toon Boom Animation</em> · ~22 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=TVPaint+hand+drawn+animation+studio+workflow+professional" data-video-id="jfkxg7xpACU" target="_blank">
    <strong>TVPaint in Professional Studios, Hand-Drawn Animation Workflow</strong><br>
    <em>Sakuga Foundry</em> · ~18 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=YouTube+animation+pipeline+solo+creator+workflow+indie" data-video-id="qY21V9QdZxY" target="_blank">
    <strong>Solo YouTuber Animation Pipeline, How Indie Creators Do It All</strong><br>
    <em>Spywi's Mind Palace</em> · ~20 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=model+sheet+character+design+animation+production+how+to" data-video-id="qO1DZCi27Xg" target="_blank">
    <strong>Model Sheets for Animation Production, How Studios Ensure Character Consistency</strong><br>
    <em>Joshua Adeoye</em> · ~22 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=Cartoon+Saloon+Wolfwalkers+animation+production+process" data-video-id="lRSo6-8SsHM" target="_blank">
    <strong>Cartoon Saloon's Production Process, Wolfwalkers Breakdown</strong><br>
    <em>Apple TV</em> · ~25 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=Toon+Boom+Storyboard+Pro+animatic+tutorial+professional" data-video-id="CqwCNDptd7o" target="_blank">
    <strong>Toon Boom Storyboard Pro, Professional Storyboarding and Animatic Workflow</strong><br>
    <em>Toon Boom Animation</em> · ~30 min<br>
...
<div class="vg-card">
  <a href="https://www.youtube.com/results?search_query=animation+color+script+visual+development+studio+pipeline" data-video-id="MCBg5Fl86x8" target="_blank">
    <strong>Color Scripts and Visual Development, How Studios Plan Their Palette</strong><br>
    <em>kdsketch</em> · ~20 min<br>
