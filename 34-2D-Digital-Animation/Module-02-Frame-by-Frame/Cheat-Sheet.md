...
| Facial expression change | 4–8 |
| Character 180° turnaround | 8–12 |
...
| Stretch + motion lines | Cartoon run start, sudden exit |

**Rule:** Smear should feel invisible during playback. If it reads as a visible drawing, it's wrong.

**Used in:** Spider-Verse, Cuphead, Demon Slayer, Arcane
...
- Floating upward arc = no gravity → add slow-out at apex
...
| **Hybrid** | P2P structure + SA fills | Complex character action |
...
- Cuphead used it to mimic 1930s Fleischer style

---

## Arc Mistake Quick Fixes

| Mistake | Quick Fix |
|---------|-----------|
| Straight-line arc | Add bow to intermediate drawing |
| Kinked arc | Find offending frame; soften direction change |
| Flat arc | Add vertical component |
| Floating arc | Add slow-out at apex; speed up near bottom |

---

## Production Examples by Technique

| Show/Film | Primary Technique | Notes |
|-----------|-----------------|-------|
| Spider-Verse | Frame-by-frame on twos | Mixed fps per character dimension |
| Cuphead | Frame-by-frame, 1930s style | All hand-drawn, smear-heavy |
| Arcane | Hybrid: key poses + 3D | Hand-painted textures |
| The Owl House | Cut-out + FbF overlays | FbF for action/emotional peaks |
| Demon Slayer | Hybrid anime + smear | Ufotable 3D/2D blend |
