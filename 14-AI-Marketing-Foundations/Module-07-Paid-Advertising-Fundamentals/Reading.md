...
> - [Module 1 The 2026 landscape](../Module-01-Digital-Marketing-Landscape-2026/Reading.md) POESM Paid bucket, walled gardens, marketing math (CAC (Customer Acquisition Cost), LTV (Lifetime Value), ROAS (Return on Ad Spend), CPM (Cost Per Mille), CPA (Cost Per Acquisition))
...
>
> If you've never logged into Google Ads or Meta Business Suite, sign up for the (free) sandbox account before the auction-mechanics section. The auction is much clearer when you've seen the "estimated reach" slider in a real UI (User Interface).
...
- **Expected click-through rate** (predicted CTR (Click-Through Rate) vs. similar ads)
...
### Sample B2B (Business-to-Business) SaaS (Software as a Service) Math
...
| **MQL (Marketing Qualified Lead) → SQL (Sales Qualified Lead) → Customer conversion** | 20% MQL→SQL, 25% SQL→Customer = 5% MQL→Customer | typical |
| **Max acceptable CPL (Cost Per Lead) (cost per lead)** | $24 | $480 × 0.05 |
...
| **Attribution challenge** | OK if Conversions API (Application Programming Interface) / Enhanced Conversions setup is clean | iOS 14.5 broke deterministic; CAPI mitigates | Native pixel + UTM |
...
| **DSP (Demand-Side Platform)** | Demand-Side Platform (programmatic ad buying tool) |
| **SSP (Supply-Side Platform)** | Supply-Side Platform (publisher ad inventory tool) |
