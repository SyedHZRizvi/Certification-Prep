...
> - Comfort with simple ratios (LTV (Lifetime Value) ÷ CAC (Customer Acquisition Cost), revenue ÷ spend)
>
...
## ☕ A Story: How Mailchimp Beat Constant Contact

It's 2007. Two email marketing companies are duking it out for the same small-business customer: **Constant Contact** (founded 1995, enterprise feel, sales-led) and **Mailchimp** (founded 2001, freemium, quirky monkey mascot).

On paper, Constant Contact had everything: more features, more sales reps, more events. Mailchimp had a free tier and a chimp.
...
The technologies both companies used SMTP (Simple Mail Transfer Protocol), HTML email, A/B tests were *identical*. What differed was their understanding of the **landscape**: that owned media (their blog) plus product-led growth (the free tier) plus user-generated content (the share-worthy dashboard) compounds in ways traditional sales cannot.
...
- **Generative Search (GEO / AEO):** Ranking inside Google's AI Overviews, Perplexity, ChatGPT Search, You.com, and the AI answer panels. Also Module 3. (New as of 2024; mainstream by 2026.)
- **App Store Optimization (ASO):** Ranking inside the Apple App Store and Google Play. Relevant if you ship a mobile app.
- **Paid Search:** Google Ads (Search, Shopping, Performance Max), Microsoft Ads, Amazon Sponsored Products. Module 7.
...
- **Reddit:** Community-driven; outsized importance because Google scrapes Reddit heavily for AI Overviews. Module 5.
...
- **Blog / long-form content:** Module 4.
- **Podcasts:** Touched in Modules 4 + 5.
- **Video (YouTube long-form, embeds):** Module 4.
- **Newsletters (Beehiiv, Substack, ConvertKit):** Modules 4 + 6.

### Commerce
- **Marketplaces** (Amazon, Walmart Marketplace, Etsy, eBay): Touched in Module 7.
- **Affiliate / partnerships:** Touched in Module 4.
- **Influencer marketing:** Module 5.
...
**A**cquisition → **A**ctivation → **R**etention → **R**eferral → **R**evenue. Read aloud, it sounds like a pirate. Hence the nickname *pirate metrics*. Used heavily in tech, SaaS (Software as a Service), mobile apps.
...
| **CPA (Cost Per Acquisition)** (Cost Per Acquisition) | Ad spend ÷ conversions | Channel-specific version of CAC |
...
🧠 **Memory mnemonic:** "CAC kills LTV unless CAC < ⅓ LTV." If LTV is $300, your blended CAC must be below $100 for the business to scale.
...
| Walled Garden | Owned By | Core Inventory | Strength | Weakness |
|---|---|---|---|---|
| **Google** | Alphabet | Search, YouTube, Display, Demand Gen, Performance Max | Intent capture, scale | Auction opacity, AI Overviews cannibalize organic |
| **Meta** | Meta | Facebook, Instagram, Threads, WhatsApp | Detailed targeting (even post-iOS-14.5), creative variety, Advantage+ Shopping | iOS-14.5 attribution gap, Reels supply outpaces demand |
| **Amazon** | Amazon | Sponsored Products, Sponsored Brands, Amazon DSP (Demand-Side Platform) | Closest-to-purchase intent | Limited brand-building, opaque organic ranking |
...
- BOFU SEO (product comparison, branded queries, "near me," reviews) still wins.
- "Generative Engine Optimization" (GEO) and "Answer Engine Optimization" (AEO) are emerging disciplines. Module 3 covers them.

### Shift 2: The Cookie Is (Finally, Sort Of) Dying

Apple's **iOS 14.5 update (April 2021)** introduced App Tracking Transparency. Roughly 75–80% of US iPhone users opted *out* of cross-app tracking. Meta lost an estimated **$10 billion in 2022 alone** to that single change (per Meta's own Q1 2022 earnings disclosure).

Google's **third-party cookie deprecation** in Chrome has been postponed multiple times (originally 2022, then 2023, then 2024, then 2025) and as of writing is moving toward an **opt-in model** rather than a hard kill. Either way, the era of "set up Facebook Pixel and call it a day" is over.

**What this means:**
- First-party data (your own email list, customer database, on-site behavior) is gold.
- Server-side tracking (Conversions API (Application Programming Interface), Enhanced Conversions) is now table stakes.
- Probabilistic / modeled attribution replaces deterministic last-click. Module 8 covers this.

### Shift 3: Walled Gardens Got Hungrier; The Open Web Got Smaller

In 2026, roughly three quarters of global digital ad dollars flow to four companies. The independent ad-tech / programmatic space shrunk. Connected TV (CTV) is the biggest growth area outside the walled gardens.
...
### Shift 5: Attribution Got Probabilistic

The combination of iOS 14.5 + cookie deprecation + AI-driven bidding (Performance Max, Advantage+) means that exact, deterministic attribution is impossible for most marketers. The 2026 best practice is **MMM + incrementality testing + platform-reported attribution + first-party tracking** layered together.

🎯 **MEMORIZE THIS:** "Last-click is dead; first-party data is gold; incrementality testing is the new A/B test."
...
A diagram of every touchpoint a customer has with you, from first awareness to post-purchase. Most modern versions include emotional state at each touchpoint. Forrester and Gartner both publish standard formats.

### OKRs (Objectives and Key Results) and KPIs
**O**bjectives + **K**ey **R**esults (popularized by John Doerr's *Measure What Matters*, 2018). KPIs (Key Performance Indicators) are the metrics that prove you hit the OKR (Objective and Key Result). A marketing OKR might be: "Objective: Grow qualified pipeline. KR: 1,000 MQLs/quarter, $5M sourced revenue."

### SOSTAC and PASTA
Two planning frameworks. **SOSTAC** (Situation, Objectives, Strategy, Tactics, Action, Control) by PR Smith is the most-taught. **PASTA** (Problem, Audience, Solution, Tactics, Action) is a startup-flavored variant.

---

## 📊 Real Case Study Anchor, Coca-Cola's "Create Real Magic" (2023)

In March 2023, Coca-Cola launched the **"Create Real Magic"** campaign, one of the first major brand campaigns built on top of GPT (Generative Pre-trained Transformer)-4 and DALL-E.
...
You will see Coca-Cola's "Real Magic" cited in HBR, MIT Sloan Management Review, and the WARC 2024 Effectiveness yearbook. It's the canonical "first big-brand GenAI campaign" reference.
...
|---|---|
| "More channels = more reach" | More channels = more cost. Master 2–3 first. |
| "Organic is free" | Organic is *unpaid in media*, not free in labor. Content, SEO, and social all cost time. |
| "AI replaces marketers" | AI replaces *tasks*. Marketers who use AI replace marketers who don't. |
| "Last-click attribution is fine" | Deterministic last-click broke in 2021. Today: MMM + incrementality + platform-reported. |
| "Cookies are gone" | Third-party cookies are dying. First-party cookies (your own analytics) still work. |
| "Personalization always wins" | Over-personalization triggers creepiness and privacy backlash (NN/g studies, 2022). |
| "Going viral is a strategy" | Viral is a *consequence*, not a plan. Plans must work without virality. |
...
| **CPM / CPC / CPA** | Cost per mille (1,000 impressions) / per click / per acquisition |
| **AOV** | Average Order Value |
| **Walled garden** | A platform that doesn't let your data leave (Google, Meta, Amazon, TikTok) |
...
| **CTV** | Connected TV (Roku, Fire TV, smart TV apps) |
| **Performance Max** | Google's AI-driven multi-placement campaign type |
| **Advantage+ Shopping** | Meta's equivalent AI-driven campaign type |
...
> **Where this leads.**
> - Inside this course: Module 2 unpacks the AI fundamentals (tokens, context window, RAG (Retrieval-Augmented Generation)) that every channel-level module references; Module 3 turns the SEO bucket of POESM into a 2026 GEO/AEO playbook; Modules 7 and 8 deepen the paid-and-measurement math you met here (ROAS, CAC, attribution).
...
- 📰 Nielsen Norman Group (nngroup.com), UX (User Experience) research that informs everything content + email.
