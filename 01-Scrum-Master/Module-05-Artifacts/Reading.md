...
## 📦 A Story: The Bakery's Three Lists

Sofia owns a bakery. She has three lists, always visible:

**List 1: The Wishlist** (the **Product Backlog**)
Every cake, pastry, croissant idea Sofia could ever bake. New customer requests. Trending desserts. New ovens she wants to try. *Hundreds* of items, ranked by what would sell most.
**Promise:** "We are working toward becoming the city's #1 pastry shop." (the **Product Goal**)

**List 2: This Week's Bake Sheet** (the **Sprint Backlog**)
Just the items Sofia and her team can actually bake this week. Maybe 12 items. Plus a plan for who bakes what.
**Promise:** "By Friday, our walk-in customers will have a chocolate-themed selection." (the **Sprint Goal**)
...
🎯 **MEMORIZE THIS TABLE.** It's worth 5+ exam points easily.
...
- 📦 Lives **in the Product Backlog** (per Scrum Guide)
...
🎯 **Exam pattern:** "Where does the Product Goal live?" → **In the Product Backlog.**
...
🎯 **Exam pattern:** "Who owns the Sprint Backlog?" → **The Developers.**

---

## 🎯 Commitment 2: The Sprint Goal
...
### What If The Sprint Goal Is At Risk?
- Developers + PO **negotiate scope** of items
- The **Sprint Goal stays**, scope of work flexes
- Don't extend the Sprint
- Don't sacrifice quality

🎯 **Exam pattern:** "Mid-sprint, the team realizes they can't deliver everything. What goes first?"
- ❌ Sprint Goal
- ✅ Lower-priority Sprint Backlog items
...
- 🚢 **Releasable** at any time (PO decides when)
...
## ✅ Commitment 3: The Definition of Done (DoD)
...
|--------------------|---------------------|
| Applies to **all** PBIs | Specific to **one** PBI |
| Quality bar | Functional bar |
...
🎯 **Exam pattern:** "An item passed acceptance criteria but failed DoD. Is it Done?"
- **No.** Both must be met.
...
4. Items meeting **DoD** become **Increment(s)**
5. Review the Increment, adapt the Product Backlog
6. Retro the process
...
| Term | Definition |
|------|------------|
| **Product Backlog** | Ordered, emergent list of all work for the product |
| **Sprint Backlog** | Sprint Goal + selected PBIs + delivery plan |
| **Increment** | Working addition to product, must meet DoD |
| **Product Goal** | Long-term target in the Product Backlog |
| **Sprint Goal** | Single objective for the Sprint |
| **Definition of Done (DoD)** | Quality bar; checklist for "done-ness" |
| **Refinement** | Activity of breaking down/clarifying PBIs |
| **PBI (Product Backlog Item)** | An item in the backlog |
| **Acceptance Criteria** | Specific conditions for ONE PBI to be acceptable |
...
- 📦 Increment: usable, must meet DoD, multiple per Sprint allowed
- ✅ DoD vs Acceptance Criteria
- 🎯 Sprint Goal stays; scope flexes
