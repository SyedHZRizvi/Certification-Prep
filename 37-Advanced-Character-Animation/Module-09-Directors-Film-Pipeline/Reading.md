...
- Decode and act on director's notes with precision
...
### Common Director Notes and What They Mean

| Director's Note | Common Meaning | Technical Translation |
|----------------|---------------|----------------------|
| "It's too much" | Over-animation; too busy | Reduce secondary motion; simplify the performance |
| "It's not alive" | Under-animation; too stiff | Add breathing; add eye movement; vary timing |
| "It's reading wrong" | The performance intent is misunderstood | Clarify the character's objective; replay with fresh eyes |
| "I want more energy" | The timing is too slow | Sharpen anticipations; reduce holds; tighten spacing |
| "It feels off" | Unspecified | ASK: "Can you point to a specific moment?" |
| "Make it feel more [character name]" | The performance lacks character-specific traits | Return to the character bible; check behavioral consistency |
| "It's almost there" | One or two specific things are wrong | Show it again and ask: "Which moment specifically?" |

### The One Question You Should Always Ask

When a note is ambiguous, ask exactly one clarifying question before leaving the review room:
*"Can you point to a specific moment in the shot that isn't working?"*

This question:
- Respects the director's time (you're not asking them to rearticulate the note)
...
| Stage | Who Is Involved | Duration |
|-------|----------------|---------|
| Assignment | Animation supervisor; animator | 30 minutes |
| Blocking pass | Animator alone | 2–5 days |
| Blocking review | Animator + animation supervisor | 30 minutes |
| Spline pass | Animator alone | 3–7 days |
...
In a group review (a "dailies" session where all animators present their work simultaneously), the group context matters:
- Other animators' shots immediately before and after yours establish expectations
- A shot that looks fine in isolation can read as slow or stiff after a fast, energetic shot
- Conversely, a subtle, understated shot can read as stronger after an over-animated one

> ⚠️ **Production truth:** The director sees 20–50 shots per dailies session. Your shot has approximately 30–60 seconds of their attention before the next shot plays. Make the most important choice readable in the first 5 seconds.
...
### The Four Rules of Revision Etiquette
...
### The "Yes, And" Approach to Director's Notes
...
| Level | Approver | What They Check |
|-------|---------|----------------|
| Animation Supervisor | Animation Supervisor | Technical quality, character consistency, pipeline compliance |
| Director of Animation | Director of Animation | Performance quality, scene-to-scene consistency |
...
- The director has signed off on the shot in its current form
- The shot has been marked as production-complete in the shot management system (Shotgun/ShotGrid/Ftrack)
- The technical review (TDs checking for rig errors, render issues) has passed
- The shot will go to the compositor as-is

> 🎯 **Exam tip:** An approved shot can still be changed at the editorial level. Editorial can cut the shot shorter, reorder it, or cut it entirely. Approval = technically and creatively complete, not = guaranteed to be in the film.
...
Before blocking a shot, animators should:
1. Watch the editorial cut (the animatic or current locked cut) 5 times
2. Identify where the shot begins and ends in the context of adjacent shots
3. Confirm the cut-in and cut-out frames with the editorial team
4. Know the emotional state the audience will be in when they enter your shot (from the preceding shot)
5. Know the emotional state your shot must deliver the audience into for the next shot

> ⚠️ **Common error:** Animating a great performance for a 5-second shot that editorial has already planned to cut to 2 seconds. The correct process is to confirm the editorial cut length before investing the blocking time.
...
### What the Anim Sup Does

| Responsibility | How It Affects You |
|---------------|-------------------|
| Defines character performance guidelines | You get a character bible; follow it |
| Reviews all animation before director | Your work must satisfy the Anim Sup before the director sees it |
| Distributes shot assignments | Complex or story-critical shots go to most experienced animators |
| Maintains cross-shot consistency | They can ask you to revise a shot to match a shot you didn't animate |
| Manages the animation team's schedule | They know when you're behind before you do |
| Buffers between animator and director | They translate director vision into animator-actionable notes |
...
|---------|-------------------|
| Director's note decoding | Translate emotion/metaphor to technical action; ask one precise clarifying question |
| "It feels off" | Always clarify: "Can you point to a specific moment?" |
| Revision etiquette | No arguing in review; implement the note first; don't change unrelated elements |
| "Yes, And" | Implement the exact note + offer one variation as a build |
| Shot approval | Supervisor → Director of Animation → Director → Producer |
| Animating to editorial | Edit length and cut points determine your shot's scope; confirm before blocking |
| Handles | 4–8 frames of hold at shot start and end for editorial flexibility |
| Anim Sup | Show early; never surprise in director review; flag schedule problems immediately |
...
### Key ShotGrid Concepts for Animators

| ShotGrid Entity | What It Represents | Animator's Use |
|---------------|------------------|----------------|
...
| Status | Shot state: wtg (waiting), ip (in progress), rev (review), fin (final) | Update every day |

### The Golden ShotGrid Rule

**Never mark a shot "final" (fin) without your supervisor's explicit approval.** Marking a shot final in ShotGrid triggers downstream departments (FX, lighting, compositing) to begin work based on your animation. Premature "fin" status wastes downstream resources and creates pipeline debt.
...
| Director Type | Communication Style | Translation Approach |
|--------------|-------------------|---------------------|
| Former animator | Technical precision ("the drag on frame 45 is too heavy") | Take the note exactly as stated; they know what they mean |
| Writer/story-background | Story language ("this character wouldn't do that") | Translate: what objective does this character have that makes this action wrong? |
| Live-action director | Performance language ("I want more vulnerability") | Translate: which FACS AUs and body posture adjustments communicate vulnerability? |
| First-time director | Uncertain notes ("it feels like something") | Your clarifying question is critical: "Can you point to a specific moment?" |
| Perfectionist director | Multiple simultaneous notes | Priority-rank: which note affects the performance story first? |

### The Note Translation Protocol
...
### What "Notes on a Scene" Reveals

Pixar's "Notes on a Scene" interviews (a series in which directors and animators discuss specific shots) consistently reveals that:
- The best performances involved 5–12 revision passes
- The first approved pass is rarely the one that survives in the final film
- Editorial changes (shot length, cut timing) force performance revisions even after the shot is "approved"
...
```
SCENARIO: Supervisor says "reduce the secondary motion in frames 45-60"
          Director says "I want more energy in frames 45-60"

STEP 1: Do not implement either note until the conflict is surfaced
STEP 2: Go to the supervisor: "I received a director note asking for more energy in frames 45-60,
        and your note asks for less secondary. Can you help me reconcile these?"
STEP 3: The supervisor either:
        (a) Clarifies: "More energy = faster anticipation, not more secondary"
        (b) Escalates to Director of Animation for adjudication
        (c) Schedules a 3-party meeting with the director to clarify

NEVER: Implement both notes (they conflict)
NEVER: Implement only the director's note without supervisor awareness
...
Module 10 is the culmination of everything: the demo reel. The document that will determine whether you get the interview at Pixar, DreamWorks, Riot, or Framestore. It is the single most important 90 seconds of an animator's career.
...
## 🔬 Appendix: The Animation Supervisor's Toolbox

Understanding what the Anim Sup has at their disposal helps animators anticipate supervisor decisions and prepare for them:

### Character Consistency Tools

| Tool | Purpose |
|------|---------|
| Character bible | Documents behavioral vocabulary, posture, and personality for every character |
| Cross-shot continuity review | Watches all approved shots in sequence to check for inconsistency |
| "Character check" shotlist | Specific poses and expressions reviewed across animators' shots for consistency |
| Reference library | Approved clips from the same character used as reference for new animators |

### Schedule Management Tools

| Tool | What It Does |
|------|-------------|
| ShotGrid capacity planning | Shows how many shots are in each pipeline stage; identifies bottlenecks |
| Animator utilization tracking | Identifies who is blocked and who has bandwidth |
