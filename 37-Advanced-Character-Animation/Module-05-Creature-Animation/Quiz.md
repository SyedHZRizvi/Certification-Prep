# Module 5 Quiz: Creature Animation 🐉

> **24 questions · Estimated time: 30 minutes**

---

### Q1. In the four quadruped gaits, which is the only gait where at least two feet are always on the ground?
A. Trot  
B. Canter  
C. Walk  
D. Gallop  
...
### Q3. In a rotary gallop (vs. transverse gallop), the footfall pattern is:
A. Right front → Left front → Left hind → Right hind  
B. Right front → Left front → Right hind → Left hind  
C. Left hind → Right hind → Left front → Right front  
D. All four feet contact simultaneously  

---

### Q4. The behavioral borrowing decision for Toothless (*How to Train Your Dragon*) was:
A. Monitor lizard and Komodo dragon  
B. Domestic cat and Labrador Retriever  
C. Horse and manta ray  
D. Crow and raven  
...
### Q7. In fish locomotion, the wave travels:
A. From tail to head (anteriorly)  
B. From head to tail (posteriorly)  
C. Laterally from one side to the other  
D. Vertically, producing dolphin-like motion  

---

### Q8. An "anguilliform" fish locomotion style is characterized by:
A. A rigid body with only the tail driving propulsion  
B. Full-body waves traveling the entire length of the animal  
C. Fin-driven locomotion with a rigid body  
D. Rear-third body waves with a rigid front section  

---

### Q9. Pectoral fins (side fins) in fish are the primary:
A. Propulsion mechanism at all speeds  
B. Steering and braking mechanism at slow speeds  
C. Secondary motion for aesthetic appeal  
D. Camouflage mechanism in open water  

---

### Q10. The most important creature animation decision to make before placing the first key is:
A. The creature's color palette and shader settings  
B. Which real-world animal's behavioral library will define the creature's personality  
C. The creature's locomotion gait and speed  
D. How many polygons the rig will have for secondary motion  

---

### Q11. A "creature bible" in animation production is:
A. A technical manual for the creature rig setup  
B. A document specifying the behavioral vocabulary for each creature type, referenced by all animators  
C. A religious text referenced for fantasy creature design  
D. A collection of all approved creature character designs  

---

### Q12. In a quadruped trot, footfall is characterized by:
A. One foot at a time in a slow sequence  
B. Diagonal pairs moving together (right front + left rear; left front + right rear)  
C. Three feet on the ground simultaneously at all times  
D. A three-beat rhythm with one leading foot  
...
### Q17. The quadruped canter is characterized by:
A. All four feet contacting the ground simultaneously  
B. A three-beat rhythm with a brief airborne phase and one leading foot  
C. A two-beat rhythm with diagonal pairs  
D. Maximum speed with no airborne phase  
...
### Q19. The common error in beginner anthropomorphic character animation is:
A. Defaulting to full human body language and forgetting animal morphology (ears, tails, muzzle)  
B. Over-animating animal appendages to the point of distraction  
C. Making the character move too slowly for its animal type  
D. Using too many behavioral reference animals simultaneously  

---

### Q20. In a gallop's transverse pattern, the footfall sequence is:
A. RF → LF → RH → LH (rotary)  
B. RF → LF → LH → RH (transverse)  
C. All four feet simultaneously  
D. LH → RH → LF → RF (reverse)  
