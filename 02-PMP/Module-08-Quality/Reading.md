# PMP Module 8: Quality Management ✅

> **Why this module matters:** ~5-10 questions. Quality is *built into* projects, not inspected at the end. Know the gurus, key tools, and the philosophy.
...
Plain English: does it do what stakeholders said they need?
...
## 🏛️ The Quality Gurus (Know These!)

### 1. W. Edwards Deming (PDCA)
- **Plan-Do-Check-Act** cycle
- 14 Points for Management
- "85% of problems are system problems, not people problems"
...
### 3. Philip Crosby
- **"Quality is free"** (preventing defects costs less than fixing)
- **Zero defects**
...
## 🔄 The 3 Quality Processes

### 1. Plan Quality Management
- Define quality requirements
- Output: **Quality Management Plan**
- Includes: standards, metrics, checklists

### 2. Manage Quality
- Translate plan into testable activities
- "Quality Assurance" (QA)
- Output: quality reports, change requests

### 3. Control Quality
- Inspect deliverables
- Verify they meet requirements
- Output: verified deliverables, work performance information

🎯 **Exam pattern:** "Inspecting deliverables to ensure they meet requirements is:"
- ✅ **Control Quality**

---

## 🛠️ The 7 Basic Tools of Quality

These are EXAM-IMPORTANT. Know them:

### 1. Cause-and-Effect Diagram (Fishbone / Ishikawa)
- Used for **root cause analysis**
- Bones = categories (e.g., People, Process, Tools)
- Helps find WHY a problem occurs

### 2. Flowcharts
- Visualize a process
- Identify bottlenecks, delays, decision points

### 3. Checksheets
- Tally counts (e.g., defects by type)
...
- Reveals patterns, central tendency, spread
...
### 7. Scatter Diagrams
- Plot 2 variables to see correlation
- Helps identify relationships

🧠 Memory: **C-F-C-P-H-C-S** ("Can Fish Catch Pretty Healthy Caribbean Salmon?")
...
- 2σ = ~95%
- 3σ = ~99.73%
- 6σ = ~99.99966% (Six Sigma!)

### Six Sigma
- Quality philosophy + methodology
...
### Quality Audit
- Independent review of project against standards
- Verifies QA processes are followed
- Identifies improvements

### Process Analysis
- Examines a process for inefficiency
- Often uses root cause analysis (fishbone)

---

## ⚠️ Common Quality Anti-Patterns
...
| Term | Definition |
|------|------------|
| **Quality** | Degree of meeting requirements |
| **Grade** | Level/feature category |
| **PDCA** | Plan-Do-Check-Act (Deming) |
| **DMAIC** | Define-Measure-Analyze-Improve-Control (Six Sigma) |
| **COQ** | Cost of Quality |
| **Fishbone Diagram** | Root cause (Ishikawa) |
| **Pareto Chart** | 80/20 frequency analysis |
| **Control Chart** | Statistical process monitoring |
| **Rule of 7** | 7 consecutive points = out of control |
| **Six Sigma** | <3.4 defects per million |
| **Tolerances** | Customer-specified range |
| **Control limits** | Process variation range |
...
4. ➡️ [Module 9: Procurement](../Module-09-Procurement/Reading.md)
...
3. **Six Sigma in a 5-person startup.** Six Sigma (Motorola, 1986) was designed for factory-scale processes. When does the rigor pay off in a small-team context, and when is it overkill? Cite PMBOK 7's Tailoring principle.
4. **Quality vs grade trade-off.** A budget airline (low grade) competes with a luxury carrier (high grade). Both can be high or low quality independently. Use real airlines as examples and defend whether grade or quality is more important commercially.
5. **Fishbone in services.** Ishikawa diagrams were developed for manufacturing root-cause analysis. Adapt the categories (typically: People, Process, Equipment, Materials, Environment, Methods) for a B2B SaaS customer-churn investigation.
...
|---|---|---|---|
| PDCA (Plan-Do-Check-Act) | Shewhart, Walter A. | 1924 (control chart); 1939 (PDCA) | *Economic Control of Quality of Manufactured Product*, Van Nostrand (1931) |
| Deming's 14 Points; PDCA popularization | Deming, W. Edwards | 1982 | *Out of the Crisis*, MIT CAES |
| Juran's Quality Trilogy | Juran, Joseph M. | 1986 | *"The Quality Trilogy,"* Quality Progress, August 1986 |
| "Quality is Free" | Crosby, Philip B. | 1979 | *Quality is Free: The Art of Making Quality Certain*, McGraw-Hill |
| Ishikawa (Fishbone) diagram | Ishikawa, Kaoru | 1968 (Japanese); 1985 (English) | *Guide to Quality Control*, Asian Productivity Organization |
| Taguchi Loss Function | Taguchi, Genichi | 1987 | *Quality Engineering Through Design Optimization* |
| Six Sigma | Smith, Bill (Motorola) | 1986 | Motorola University internal publication |
| DMAIC | Motorola | 1986; codified GE 1995 | Six Sigma Black Belt curriculum |
| Pareto principle (80/20) | Pareto, Vilfredo (1896); applied to quality by Juran | 1896; 1951 | *Quality Control Handbook* (Juran, 1951) |
| Control charts + Rule of 7 | Shewhart, Walter A. | 1924 | original Bell Labs internal memo (Shewhart) |
| Cost of Quality (Prevention/Appraisal/Internal-Failure/External-Failure) | Feigenbaum, Armand V. | 1956 | *"Total Quality Control,"* Harvard Business Review |
| ISO 9001 quality management system | International Organization for Standardization | 2015 (current); 1987 (original) | ISO 9001:2015 |
| Quality Principles (PMBOK 7 §3.8) | Project Management Institute | 2021 | PMBOK 7 |
| Hubble Optical Systems Failure Report ("Allen Board") | NASA | 1990 | *Hubble Space Telescope Optical Systems Failure Report*, NASA TM-103443 |
| Standish CHAOS Report (quality failure data) | Standish Group | 2024 | *CHAOS Report 2024* |
