...
## 🔬 The 60-Second Showreel Structure

### The Four-Zone Structure

| Zone | Duration | Content | Goal |
|------|----------|---------|------|
| **Hook** | 0–5s | Your single best shot | Stop the skip; establish quality |
| **Body** | 5–45s | 6–10 pieces at 4–8 seconds each | Demonstrate range and skill |
| **Climax** | 45–55s | A longer, complex piece | Prove depth; the payoff |
| **Close** | 55–60s | Name, contact, website | Leave a professional impression |
...
For each piece in your reel, ask: **"Why is this piece in the reel? What specific skill does it demonstrate?"**

- Demonstrates: AE expression control → keep
- Demonstrates: Typography timing → keep
- Demonstrates: "I animated something once" → cut
...
## 🎯 What the Exam Tests: Showreel & Client Work
...
## 💰 Pricing Motion Design Work

### Day Rate vs Project Rate

| Model | Best For | Risk |
|-------|----------|------|
| **Day Rate** | Unclear scope, onsite work, ongoing client relationships | Low (you get paid regardless of time) |
| **Project Rate** | Well-defined deliverables, repeat formats, tight creative scope | Medium (scope creep risk) |
| **Hourly Rate** | Very small tasks, consultation | High (clients have sticker shock on large hour counts) |

### 2026 Freelance Rate Benchmarks

| Experience | Day Rate | Project Rate Range |
|-----------|----------|-------------------|
| Junior (0–2 years) | $300–$600/day | $500–$2,000/project |
| Mid-level (2–5 years) | $600–$1,200/day | $2,000–$8,000/project |
| Senior (5–10 years) | $1,200–$2,500/day | $5,000–$25,000/project |
| Expert/Director (10+ years) | $2,500–$5,000+/day | $15,000–$100,000+/project |

> 🚨 **Trap on the Exam:** Day rates for motion design are NOT the same as designer hourly × 8. They reflect overhead, non-billable time (administrative, business development), software licenses, hardware depreciation, and the market value of specialized skill. A day rate of $1,000 for a mid-level designer working in New York is not excessive.

---

## 📋 Client Briefs

A brief is the document that defines the project before any work begins. A good brief prevents 80% of revision cycles.

### The Essential Brief Components

| Section | Contains |
|---------|---------|
| **Project Overview** | What is this? (video type, context, platform) |
...
## 💼 The Motion Design Studio Landscape

Understanding the studio landscape helps you position yourself for the right opportunities and set realistic rate expectations.

### Studio Tiers and Characteristics

| Tier | Examples | Project Types | Rate for Freelancers | Hiring Signal |
|------|----------|---------------|---------------------|---------------|
...
**Include 2 rounds of revisions in every project rate.** This is the industry standard. State it explicitly in your proposal:

> "This project includes two rounds of revisions. Each round is one consolidated set of changes submitted together. Additional rounds are available at $X/hour."

### Managing Revision Creep
...
A professional proposal prevents scope creep, establishes payment terms, and sets the revision policy before any work begins. Here is the minimum viable structure:

### Section 1: Project Overview
> "This proposal covers the creation of a 30-second animated brand video for [Client Name], to be delivered as [formats/specs]. This document supersedes all previous verbal or written communications about this project."

### Section 2: Scope of Work
A detailed, numbered list of exactly what will be delivered:
1. One 30-second animated brand video, 1080×1920 (9:16), 30fps, H.264 .mp4
2. One 30-second animated brand video, 1920×1080 (16:9), 30fps, H.264 .mp4
...
|-----------|------|
| Reference call | [Date] |
| Concept/storyboard delivery | [Date] |
| Draft 1 delivery | [Date] |
| Client feedback (round 1) | [Date, client's deadline] |
| Revision 1 delivery | [Date] |
| Client feedback (round 2) | [Date, client's deadline] |
| Final delivery | [Date] |

**Timeline contingency:** The final delivery date assumes client feedback is received by the dates above. Delayed feedback pushes the final delivery by the same number of days.

### Section 6: Ownership and Usage
> "Client receives full usage rights to the final delivered video files upon receipt of final payment. Designer retains the right to display the work in portfolio, showreel, and case studies after public release of the video."

---

## ⚖️ Licensing and Spec Work Ethics

### Project Licensing

When you complete a motion design project for a client, what are you handing over? This depends on the contract.

| Right | Default (No Contract) | Best Practice |
|-------|----------------------|--------------|
| Usage rights | Varies by jurisdiction | Define: "Client has unlimited usage rights for the final delivered files" |
| Raw project files | Designer retains | If client wants raw AEP files, charge extra |
| Portfolio use | Designer keeps | Explicitly state in contract |
| Attribution | Optional | Request credit in video description |
...
> 🎯 **Exam Tip:** This is an ethics question that appears on School of Motion assessments. The answer is always: paid pitches (a small fee to cover pitch time) or no pitch at all.

### Showreel Licensing for Client Work

Can you put client work in your showreel? Generally yes, with these conditions:
- The project has been publicly released
- The contract does not include an NDA covering the work
...
## 🌐 Building Your Professional Presence Beyond the Showreel

The showreel is the minimum viable portfolio for a motion designer. A full professional presence includes additional channels:

### The Motion Design Platform Stack (2026)

| Platform | Primary Audience | Best Content Type | Frequency |
|----------|-----------------|-------------------|-----------|
| **Vimeo** | Creative directors, agencies | High-quality showreel + individual pieces | Ongoing |
| **Behance** | Design community + agencies | Case studies with process | Per project |
...
A case study is distinct from a showreel:
- **Showreel:** 60 seconds, best work only, no explanation
- **Case study:** 3–5 minutes, one project, full narrative (brief → concept → execution → result)
...
3. Concept / approach (1 paragraph + sketches/storyboards if available)
4. Execution (the animation itself, full length)
5. Result (deliverables, reception, any measurable outcome)
6. What you'd do differently (shows self-awareness and growth mindset)
...
| Topic | Key Takeaway |
|-------|-------------|
| Reel Length | 60 seconds max; 45 seconds is better |
| Hook Zone | 0–5 seconds with strongest piece |
| Ruthless Edit | Hesitate to include = cut it |
| Sequencing | Strongest first and last; alternate pace |
| Day Rate | $300–$2,500+/day depending on experience |
| Project Rate | 2 rounds of revisions standard |
| Brief | Reference call is the most important conversation |
| Licensing | Raw files cost extra; portfolio rights = keep |
| Spec Work | Do not do it; it devalues the profession |
...
## 📊 Freelance Rate Benchmarks by Context (2026)

| Context | Junior Day Rate | Mid Day Rate | Senior Day Rate |
|---------|----------------|--------------|-----------------|
| Local agency | $300–$500 | $600–$900 | $1,000–$1,800 |
| Remote / national agency | $400–$650 | $800–$1,200 | $1,200–$2,200 |
| Tech company (in-house contract) | $500–$750 | $900–$1,500 | $1,500–$3,000 |
| Broadcast / network TV | $450–$700 | $800–$1,400 | $1,400–$2,500 |
| NYC / LA / SF premium | +20–40% across all tiers | | |
| Retainer (monthly, 10 days/mo) | 10–15% discount from day rate | | |

*Day rates fluctuate with market conditions and specialization. AE expression specialists command a 20–30% premium over generalist motion designers at the same experience level. Lottie/web animation specialists command 15–25% premium at tech companies.*

---

## 🎬 Case Study: How Buck Evaluates Showreels

Buck (the studio behind Google's motion identity, Headspace, Apple TV+, and hundreds of other high-profile projects) is one of the most selective studios in motion design. Understanding how they evaluate showreels is the clearest window into what a professional-grade reel requires.
...
**The "8-Second Hold" Test:**
Buck creative directors apply what they internally call the "8-second hold" test: after a piece appears on screen, can you immediately identify what is excellent about it without reading the credits? If the work requires context to appreciate, it doesn't work in a reel format.

**The Practical Lesson:**
For each piece you include in your reel, apply the 8-second test yourself. Show it to someone who doesn't know your work. Wait 8 seconds. Ask: what do you notice? If they notice what you intended them to notice, the piece belongs in the reel. If they notice something else, the staging is wrong.

---

## 📊 Client Brief Evaluation Checklist

| Brief Element | Red Flag | Good Sign |
|---------------|----------|-----------|
| Objective | "Make it look cool" | "Increase signup conversions by 20%" |
| Audience | "Everyone" | "Design-aware 25–35 professionals on mobile" |
| Duration | Not specified | Exact seconds given |
| References | None provided | 5+ specific video examples |
| Budget | Not discussed | Specific number provided upfront |
| Timeline | "ASAP" | Specific dates for draft, approval, final |
| Revisions | "As many as needed" | "2 rounds included" |
| Deliverables | "A video" | Specific file formats, sizes, and versions |
| Brand guidelines | No document exists | Full brand guide provided |
| Decision maker | Unclear who approves | Named individual identified |
