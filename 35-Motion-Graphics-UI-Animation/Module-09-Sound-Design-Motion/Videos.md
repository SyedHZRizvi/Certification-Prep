---
permalink: /35-Motion-Graphics-UI-Animation/Module-09-Sound-Design-Motion/Videos/
title: "Module 9: Videos, Sound Design & Motion"
---

# 🎬 Module 9 Videos, Sound Design & Motion
...
<a class="vg-card" data-video-id="dX_1B0w7Hzc" href="https://www.youtube.com/results?search_query=after+effects+sync+animation+audio+music+tutorial">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">School of Motion · Time markers, transients, beat syncing workflow</div>
  </div>
</a>

<a class="vg-card" data-video-id="3LNsv-8OEQY" href="https://www.youtube.com/results?search_query=sound+design+motion+graphics+sfx+workflow">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Ben Marriott · How to choose and layer SFX for motion pieces</div>
  </div>
</a>

<a class="vg-card" data-video-id="LjTzVvXO3vU" href="https://www.youtube.com/results?search_query=after+effects+audio+spectrum+visualizer+tutorial">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Jake In Motion · Digital, analog, and circular spectrum setups</div>
  </div>
</a>
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=epidemic+sound+artlist+royalty+free+music+comparison" data-video-id="qj2n7eU2Axk">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Motion Designer's Review · Which platform for client and personal work</div>
  </div>
</a>
...
<a class="vg-card" data-video-id="Vh9ycqYpJOU" href="https://www.youtube.com/results?search_query=motion+graphics+sound+design+sfx+sweetening+technique">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Mobox Graphics · The sounds you feel before you hear them</div>
  </div>
</a>

<a class="vg-card" data-video-id="2YY6bVfRyqU" href="https://www.youtube.com/results?search_query=after+effects+convert+audio+to+keyframes+tutorial">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Motion Design School · Using audio amplitude data to drive animations</div>
  </div>
</a>
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=tone+of+motion+emotional+audio+animation+matching" data-video-id="3WkOtaOxUXs">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">School of Motion · How audio choice shapes animation decisions</div>
  </div>
</a>

<a class="vg-card" data-video-id="H_8dqXqWvHA" href="https://www.youtube.com/results?search_query=soundsnap+freesound+sfx+library+motion+graphics+workflow">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Jake In Motion · Freesound, Soundsnap, Zapsplat, building a workflow</div>
  </div>
</a>
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=walter+murch+sound+design+film+theory" data-video-id="Hv7XvFIFp7k">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Film School · The father of sound design on audio-visual synchrony</div>
  </div>
</a>
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=music+licensing+sync+license+commercial+video+explained" data-video-id="ql3hXGSmKqo">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">School of Motion · Legal basics every motion designer must understand</div>
  </div>
</a>

<a class="vg-card" data-video-id="QNKAB3UCj1A" href="https://www.youtube.com/results?search_query=circular+audio+visualizer+after+effects+advanced">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Mobox Graphics · Circular path setup, color animation, ring effects</div>
  </div>
</a>

<a class="vg-card" data-video-id="X4BCLYUmFeg" href="https://www.youtube.com/results?search_query=after+effects+music+video+title+sequence+sound+sync">
  ...
  <div class="vg-card-body">
    ...
    <div class="vg-card-meta">Jake In Motion · Full project: music selection through beat-synced animation</div>
  </div>
</a>
