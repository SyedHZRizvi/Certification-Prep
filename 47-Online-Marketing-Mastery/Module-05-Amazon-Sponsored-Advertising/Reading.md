...
> **Prerequisites:** Module 01 (Digital Marketing Fundamentals), basic understanding of PPC (Pay-Per-Click) concepts (CPC, impressions, clicks), familiarity with the Amazon Seller Central or Vendor Central interface.
...
3. Adjusted bids based on ACoS (Advertising Cost of Sale) vs. her 30% target
...
- CPC (Cost Per Click) and CPM (Cost Per Mille) (cost per thousand impressions) bidding options
