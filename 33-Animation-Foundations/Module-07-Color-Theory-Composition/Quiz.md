# Module 7 Quiz: Color Theory & Composition

> **Instructions:** 24 questions. Aim for 21/24.

---

### Q1. In color theory, "value" refers to:

A. The monetary worth of a color in production terms
B. The lightness or darkness of a color, independent of hue
C. The emotional intensity of a color choice
D. The saturation level of a specific hue
...
### Q3. Colors that are adjacent to each other on the color wheel are called:
...
### Q4. Complementary colors on the color wheel are:

A. Colors that harmoniously blend because they share similar hues
B. Colors that are directly opposite each other on the wheel, creating high contrast
C. Three colors equally spaced around the wheel
D. Colors created by mixing two primary colors together

---

### Q5. In *Inside Out*, the desaturation of San Francisco's color palette as the film progresses is used to communicate:

A. The economic decline of San Francisco during the story's timeframe
B. The progression of seasons from summer (saturated) to fall/winter (desaturated)
C. Riley's deteriorating emotional state and growing depression
D. The contrast between the colorful interior mind-world and the realistic exterior world

---

### Q6. A "high-key" color palette in animation uses:

A. Predominantly dark values with strong shadow areas
B. Predominantly light values, creating an open, bright, often joyful mood
C. High saturation with complementary color accents
D. A single hue in multiple saturations
...
### Q10. A monochromatic color palette uses:

A. A single hue in multiple values and saturations
B. Multiple colors with no dominant hue
C. Two complementary hues in equal proportions
D. Colors from three equally spaced positions on the wheel

---

### Q11. "Chromatic aberration" as used in *Into the Spider-Verse* refers to:

A. A mistake in the digital rendering pipeline where colors are incorrectly calculated
B. A stylistic effect simulating camera lens distortion where color channels slightly misalign
C. The specific color palette associated with dimensional boundary crossing sequences
D. A technique for separating foreground and background through color contrast
...
### Q13. The composition principle "figure-ground relationship" refers to:

A. The placement of characters at the top or bottom of a frame
B. The use of perspective to establish depth between foreground and background characters
C. High contrast between the subject and its background to ensure the subject reads clearly
D. The technique of using background characters to comment on foreground action
...
### Q15. A triadic color harmony uses:

A. Three colors adjacent to each other on the color wheel
B. Three colors equally spaced around the color wheel (120 degrees apart)
C. One color and its two complements
D. A single hue plus its warm and cool tints

---

### Q16. Which statement best describes how "leading lines" function in animation composition?

A. Lines of dialogue that lead the audience to understand the scene's exposition
B. Visual lines in the environment (architectural, natural) that guide the viewer's eye to the focal point
C. The path of motion that a character follows through a shot
D. Guidelines used in the rough animation pass before cleanup
...
### Q19. When creating a character palette for an ensemble cast, a key consideration is:

A. Each character should use colors from a different position on the color wheel
B. The ensemble palette should form a complete triadic harmony when all characters are viewed together
C. Characters must be distinguishable from each other, especially in scenes where they appear together
D. The protagonist's palette should use the highest saturation in the ensemble

---

### Q20. The Pixar rule "establish strong value relationships first" means:

A. Expensive production values must be established before color palettes are locked
B. A composition that works in grayscale (good value contrast) will work in full color; one that fails in grayscale will fail in color
C. The most narratively important character should have the brightest value in every scene
D. Value (brightness) is always more emotionally impactful than hue in Pixar films

---

### Q21. A scene that needs to communicate safety, innocence, and joy would most effectively use which palette type?

A. Low-key (dark values, strong shadows)
B. Desaturated and cool
C. High-key (light values, bright, open)
D. Monochromatic in purple

---

### Q22. The "complementary accent" technique in professional color design refers to:

A. Using equal amounts of two complementary colors throughout a composition
B. Using a primarily analogous palette with a single accent element in the complementary color to draw the eye
C. Paying compliments to the director when presenting color design choices
D. Alternating between complementary palettes in consecutive scenes

---

### Q23. In the context of animation, "color temperature" refers to:

A. The literal temperature of a light source measured in Kelvin, used in lighting setups
B. The perception of colors as warm (red, orange, yellow) or cool (blue, purple, green), and how this affects emotional reading and depth
C. The speed at which colors appear to change during a scene
D. The range of colors that a character's palette can shift between during their emotional arc

---

### Q24. A composition where the subject is placed at one of the four power points of a 3x3 grid is applying:
