...
.vg-thumb { position: relative; aspect-ratio: 16 / 9; background: linear-gradient(135deg, #22d3ee, #6366f1); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 48px; }
...
# 🎥 Module 7 Videos: Color Theory & Composition
...
<div class="vg-grid" markdown="0">
  <a class="vg-card" href="https://www.youtube.com/results?search_query=complementary+colors+animation+film+warm+cool+depth" data-video-id="Qj1FK8n7WgY" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      ...
      <p class="vg-title">Warm vs Cool Color in Animation Depth and Mood</p>
      <p class="vg-creator">Gurney Journey / Sinix Design</p>
...
1. Pick a scene from *Inside Out* or *Coco*. Describe its color palette and what emotional state it communicates.
2. Name the three primary colors and their secondaries. Identify two complementary pairs.
3. What does "value" mean in color theory, and why is it more important than hue for readability?
