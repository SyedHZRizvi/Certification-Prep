# Module 6 Quiz: Character Design

> **Instructions:** 24 questions. Aim for 21/24.

---

### Q1. In shape language theory, which basic geometric shape is most associated with friendliness, approachability, and youth?
...
### Q2. Which basic shape is associated with danger, instability, and menacing energy in character design?
...
### Q4. The "silhouette test" in character design involves:

A. Photographing the character in natural light to see their authentic color values
B. Filling the character design with solid black and determining if it is still readable and identifiable
C. Drawing the character at a very small scale to see if the proportions are consistent
D. Presenting the design without color to the director for approval before coloring begins

---

### Q5. A character design fails the silhouette test when:

A. The design uses too many colors and is not readable in black and white
B. The character cannot be identified or their action cannot be understood from their black shape alone
C. The character's proportions are inconsistent with the production's other characters
D. The design requires animation test footage to prove it will work in motion

---

### Q6. A "character turnaround" (or model sheet) shows the character in which set of views?

A. Close-up, medium shot, wide shot, and extreme wide shot views
B. Multiple action poses demonstrating the character's personality and physical abilities
C. Front, 3/4 view, side (profile), back, and 3/4 back views
D. Front view only, with proportional measurements labeled

---

### Q7. In character design for animation, why is it important to indicate clear joint locations in the design?

A. So the character can be scanned into 3D rigging software with automatic joint placement
B. So all animators (or riggers) understand where limbs bend, maintaining consistent in-betweening
C. So directors can see which poses are possible for the character before production begins
D. So background artists know how much space the character will occupy in any scene

---

### Q8. A character's hair is designed to be extremely detailed with individual strands and complex layering. This design decision is most problematic because:

A. Hair color typically requires the most expensive digital rendering techniques
B. Complex hair designs are difficult for non-specialist animators to redraw consistently
C. Detailed hair may obscure the face in extreme poses, reducing facial expression readability
D. Hair design requires a separate model sheet, adding to production cost

---

### Q9. Which color is most commonly associated with trustworthiness, calm, and reliability in character design?
...
### Q11. A character's design should be "slightly asymmetrical" according to professional design practice. Why?

A. Perfect symmetry in characters is technically impossible to animate at 24fps
B. Slight asymmetry allows more natural, less robotic animation and reflects the reality that living things are rarely perfectly symmetrical
C. Asymmetrical designs require fewer drawings in a walk cycle
D. Perfectly symmetrical designs are copyrighted and cannot be used in commercial animation
...
### Q13. A purple/dark color palette in character design is most commonly associated with:

A. Heroic virtue and moral clarity
B. Youthful energy and playfulness
C. Power, mysticism, royalty, or villainy
D. Natural environments and growth themes
...
### Q15. Which of the following design choices would create the MOST problems for a character who needs to have complex facial expressions during animation?

A. A simplified, geometrically clean design with large eyes
B. Hair that falls over the upper half of the face in a natural resting position
C. A rounded chin and high cheekbones
D. Slight asymmetry in the eyebrow shapes

---

### Q16. In Pixar's color theory for character design, Elsa from *Frozen* uses a primarily cool blue color palette to communicate:
...
### Q17. A character designer creates a hero using primarily circular shapes and a villain using primarily triangular shapes for a children's animated film. This is:
...
### Q18. The character Jinx (Powder) from *Arcane* uses blues, purples, and pinks in her color palette despite being a protagonist. This demonstrates:
...
### Q19. A character's overall silhouette is most importantly determined by:
...
### Q20. When designing characters for an ensemble cast, a key consideration for each character's color palette is:

A. All ensemble characters should share complementary colors to create visual harmony
B. Each character should be distinguishable from others in the ensemble, especially in scenes where they appear together
C. The principal character should use the most saturated colors; supporting characters should use desaturated versions
D. Characters who interact frequently should use similar colors to signal their relationship
...
### Q22. In professional freelance animation work, who typically owns the character designs created by a freelance designer?

A. The designer always retains copyright regardless of employment relationship
B. Ownership depends on the contract; typically the client/employer owns designs created for their project
C. The designs are automatically jointly owned by both the designer and the client
D. Designs are automatically in the public domain once delivered to the client
