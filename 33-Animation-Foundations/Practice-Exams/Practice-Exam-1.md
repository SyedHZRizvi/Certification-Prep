# Practice Exam 1: Animation Foundations

> **When to take this:** After completing Modules 1–5. Target score: 24/30 (80%).
> **Time:** 35 minutes. No notes.

---

### 1. Which Disney animator published the 12 Principles in the 1981 book *The Illusion of Life*?

A. Walt Disney and Ub Iwerks
B. Frank Thomas and Ollie Johnston
C. Chuck Jones and Tex Avery
D. Ward Kimball and Marc Davis

---

### 2. Squash and stretch requires that the object maintain what property through all deformation?

A. Its diameter at the widest point
B. Its volume (mass)
C. Its height from bottom to top
D. Its surface area

---

### 3. In *Bambi*, the deer-on-ice scene most directly demonstrates which principle through the extreme behavior of ice removing normal friction?
...
### 4. A storyboard arrow pointing inward (toward the center of the frame) indicates:

A. A pan right
B. A tilt up
C. A camera push (moving toward the subject)
D. A dissolve transition
...
### 7. The production method where an animator draws frame 1, then frame 2, then frame 3 in sequential order is called:
...
### 8. Which principle states that different body parts move at different times and rates, with some continuing to move after the primary body has stopped?
...
### 12. At 24fps, how many unique drawings per second does animation "on 2s" contain?
...
### 14. PAL television (used in Europe) broadcasts at which frame rate?
...
### 15. The "silhouette test" in character design requires:

A. The character to be drawn in three values (light, mid, dark) before full color is applied
B. The character to be filled with solid black and remain identifiable and action-readable from that shape alone
C. The character's outline to be drawn without any overlapping internal lines
D. Presenting the character design to a focus group in black and white before color approval

---

### 16. A character's walk cycle at 20–24 frames per step (at 24fps) communicates:

A. A child running energetically
B. A standard adult walking at a normal pace
C. A menacing, deliberate, powerful character
D. A character moving through water or heavy resistance

---

### 17. In the dope sheet, the dialogue column is used to:

A. Record the full script for reference during production
B. Map phonemes to specific frame numbers for lip sync planning
C. Track which voice actor performed each line
D. Indicate the tempo of the musical score

---

### 18. "Secondary action" is correctly applied when it:

A. Replaces the primary action in scenes where the primary is too complex to animate
B. Supports and enriches the primary action without competing for the audience's attention
C. Appears in a reaction shot by a different character after the primary action
D. Occurs simultaneously with a secondary character's movement

---

### 19. Which of the following best explains why Muybridge's *Animal Locomotion* plates are still studied in animation schools today?
...
### 20. A character design where the hair covers the upper half of the face in a resting position creates a production problem because:

A. Hair in this position requires twice as many drawings per scene
B. In extreme poses (emotional expressions, action), the hair will obscure the facial expression, reducing readability
C. Characters whose faces are partially obscured cannot pass the silhouette test
D. Covered faces create continuity problems when the character turns to profile
...
### 22. The industry-preferred professional reel hosting platform for animation is:
...
### 23. Which of the following is NOT one of the 12 Principles of Animation?
...
### 24. *Spirited Away* won the Academy Award for Best Animated Feature in 2003. Why was this historically significant?

A. It was the first Hayao Miyazaki film to receive international theatrical distribution
B. It was the first animated film to win the award since *Beauty and the Beast* in 1992
C. It was the first non-English-language animated feature film to win the award
D. It was the first Studio Ghibli film to be animated digitally rather than hand-drawn

---

### 25. The "Final Rule" in animation file management states:
...
### 28. "Limited animation" as developed for television was characterized by:

A. The use of limited color palettes to reduce production cost
B. Fewer frames per second, simplified designs, and minimal character movement
C. The exclusive use of voice acting rather than physical performance
D. Limiting each episode to a single location to reduce background production cost

---

### 29. For a first bouncing ball animation, which checklist item indicates the ball has PASSED the squash and stretch requirements?

A. The ball changes color when it hits the floor, indicating impact
B. The ball widens at impact while maintaining the same overall area as the pre-impact ball
C. The ball remains a perfect circle throughout the entire bounce
D. The ball stretches to exactly twice its original height on each upward arc
