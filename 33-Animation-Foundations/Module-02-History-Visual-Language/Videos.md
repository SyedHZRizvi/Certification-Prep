...
.vg-thumb { position: relative; aspect-ratio: 16 / 9; background: linear-gradient(135deg, #0ea5e9, #6366f1); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 48px; }
...
# 🎥 Module 2 Videos: Animation History & Visual Language

> **How to use:** Start with the Essential block for the historical sweep. Recommended block covers visual language and cinematography. Optional dives are for those who want deeper context on specific eras or films.
...
1. Name two ways *Into the Spider-Verse* visually references the Fleischer/rubber-hose aesthetic.
2. What is the 180-degree rule, and why does breaking it feel disorienting?
3. How does camera angle communicate power in the scene you named from *Spirited Away*?
4. What was the economic force that created "limited animation"?
5. Why does the Rule of Thirds produce more dynamic compositions than centered framing?

If you can answer all 5, move to the [Quiz](./Quiz.md).
