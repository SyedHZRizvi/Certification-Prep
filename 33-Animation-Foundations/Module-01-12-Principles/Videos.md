...
.vg-thumb { position: relative; aspect-ratio: 16 / 9; background: linear-gradient(135deg, #f97316, #ec4899); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 48px; }
...
<div class="vg-grid">
  <a class="vg-card" data-video-id="uDqjIdI4bF4" href="https://www.youtube.com/results?search_query=Alan+Becker+12+principles+of+animation" target="_blank" rel="noopener">
  ...
  <a class="vg-card" href="https://www.youtube.com/results?search_query=Aaron+Blaise+squash+stretch+animation+Disney" data-video-id="haa7n3UGyDc" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">Squash & Stretch Explained by a Disney Animator</p>
...
<div class="vg-grid">
  <a class="vg-card" href="https://www.youtube.com/results?search_query=Spider-Man+Into+the+Spider-Verse+animation+style+breakdown" data-video-id="l96IgQmXmhM" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      ...
      <p class="vg-title">Into the Spider-Verse Animation Breakdown</p>
      <p class="vg-creator">Corridor Crew / kaptainkristian</p>
...
## 🏆 Best Channels for Animation Principles

| Channel | Why |
|---------|-----|
| **Aaron Blaise** | 30-year Disney veteran (Mulan, Brother Bear); teaches principles with studio-grade demonstrations |
| **Alan Becker** | Most accessible explanation of all 12 principles; great for first-time learners |
| **Bloop Animation** | Practical, modern coverage of principles applied to current workflows (2D + 3D) |
...
Answer these in your notebook without rewatching:
...
If you can answer all 5, move to the [Quiz](./Quiz.md). Otherwise, rewatch the Essential block.
