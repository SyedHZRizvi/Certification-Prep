---
permalink: /19-Bitcoin-Cryptocurrency/
title: Bitcoin & Cryptocurrency Track
---
...
1. **The total newcomer.** You've heard "blockchain" used as a synonym for "magic" in every boardroom for a decade and you're done pretending. Start here.
2. **The software engineer who needs to ship.** You're being asked to integrate Bitcoin payments, custody, or Lightning into a product and you can't tell BIP-39 from BIP-44 from BIP-141. Catch up here.
3. **The finance / compliance / risk professional.** Your bank, your fund, your regulator, or your client is suddenly in the Bitcoin business and you need to grade vendors' custody designs, AML programs, and risk registers without being snowed. Land here.

Either way, by the end of this track you will be able to walk into a 2026 institutional-crypto job interview and discuss SegWit, Taproot, Lightning channel commitments, MPC vs multi-sig, the Travel Rule, MiCA's CASP regime, and the BlackRock IBIT spot-ETF mechanics without faking it.
...
|---|--------|------|--------------------|
| 1 | [Bitcoin White Paper & Origins](./Module-01-Bitcoin-White-Paper-Origins/Reading.md) | 3 hrs | Cypherpunks, Nakamoto, the 9-page paper, double-spend, the Genesis block, Hal Finney |
| 2 | [Cryptographic Foundations](./Module-02-Cryptographic-Foundations/Reading.md) | 4 hrs | Hash functions (SHA-256, RIPEMD-160), public-key crypto, ECDSA/secp256k1, Merkle trees, Schnorr |
| 3 | [Bitcoin Network & Consensus](./Module-03-Bitcoin-Network-Consensus/Reading.md) | 4 hrs | P2P network, full nodes vs SPV, mempool, blocks, longest-chain rule, soft/hard forks |
| 4 | [Wallets, Keys & Self-Custody](./Module-04-Wallets-Keys-Self-Custody/Reading.md) | 3.5 hrs | BIP-32/39/44, seed phrases, HD wallets, address types, multi-sig, hardware wallets, inheritance |
| 5 | [Mining & Proof-of-Work Economics](./Module-05-Mining-Proof-of-Work-Economics/Reading.md) | 3.5 hrs | PoW, difficulty adjustment, halvings, hashrate, mining pools, ASICs, energy debate |
| 6 | [Bitcoin Script & Programmability](./Module-06-Bitcoin-Script-Programmability/Reading.md) | 3 hrs | Stack-based scripting, P2PKH/P2SH/P2WPKH, SegWit, Taproot, MAST, Schnorr aggregation |
| 7 | [Lightning Network & Layer-2](./Module-07-Lightning-Network-Layer-2/Reading.md) | 4 hrs | Payment channels, HTLCs, BOLT specs, routing, watchtowers, splicing, sidechains (Liquid, RSK) |
| 8 | [Regulatory, Compliance & Tax](./Module-08-Regulatory-Compliance-Tax/Reading.md) | 4 hrs | FinCEN MSB, FATF Travel Rule, MiCA, SEC/CFTC, IRS Notice 2014-21, AML/KYC, sanctions |
| 9 | [Trading, Custody & Institutional](./Module-09-Trading-Custody-Institutional/Reading.md) | 3.5 hrs | Spot ETFs (IBIT, FBTC, ARKB), exchanges, OTC desks, custody (cold/warm/hot), CCSS, prime brokers |
| 10 | [Beyond Bitcoin: The Blockchain Ecosystem](./Module-10-Beyond-Bitcoin-Blockchain-Ecosystem/Reading.md) | 3 hrs | Ethereum, smart contracts, DeFi, stablecoins, NFTs, CBDCs, where Bitcoin fits in 2026 |

**Total study time:** ~35 hours of reading + 15 hours of videos + 12 hours of quizzes + 8 hours of practice exams ≈ **~85–120 hours**
...
## 🎓 The Real-World Certification Ladder

Completing this course makes you exam-ready for a four-tier industry ladder. Each tier independently signals to employers; you can climb one rung at a time.
...
- C4 CBP: <https://cryptoconsortium.org/certifications/cbp/>
...
### 10-week sprint (if you already know cryptography or are a software engineer)

```
Week 1:  Modules 1 & 2          → Quizzes 1 & 2
Week 2:  Module 3               → Quiz 3
Week 3:  Module 4 + run Bitcoin Core on a testnet node
Week 4:  Module 5  + Practice Exam 1 (30 Q)
Week 5:  Module 6
Week 6:  Module 7 + spin up an LND node on signet
Week 7:  Module 8
Week 8:  Module 9 + Practice Exam 2 (50 Q)
Week 9:  Module 10
Week 10: Final Mock (75 Q) → fix gaps → sit the C4 CBP
```

### 14-week deliberate path (if Bitcoin is brand new)

```
Weeks 1–2:  Module 1                  → read the white paper twice; watch Antonopoulos
...
This is a *foundations + practitioner* course. It gets you to credible-junior-to-mid bar in institutional crypto and to senior bar in a non-crypto firm that needs one Bitcoin specialist. Realistic 2026 titles:

| Role | What you need from this course |
|---|---|
| Bitcoin / Crypto Compliance Analyst | Modules 4, 8, 9 |
| Custody Operations Analyst (BitGo, Anchorage, Coinbase Custody) | Modules 4, 9, plus CCSS deep-dive |
| Trade Surveillance Analyst (digital assets desk) | Modules 8, 9 |
...
For senior engineer or head-of-digital-assets roles, you'll still need 3–5 years of crypto-specific experience. This course is the credible foundation you build that experience on top of.
...
👉 [**Module 1: Bitcoin White Paper & Origins**](./Module-01-Bitcoin-White-Paper-Origins/Reading.md)
