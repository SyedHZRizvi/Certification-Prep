...
## 🎯 A Real Story: Amazon Opens FBA (Fulfillment by Amazon) to Shopify (2024)
...
| UPS | Mid-weight, B2B (Business-to-Business) + residential | Reliable; expensive |
...
2. **Free shipping over $X**, Threshold; common DTC pattern. Lifts AOV (Average Order Value) but reduces order volume.
...
> **Where this leads.**
> - Inside this course: Module 7 returns to fulfillment when discussing Amazon Ads ACoS (Advertising Cost of Sale) math; Module 9 returns when discussing GA4 fulfillment events; Module 10 returns deeply for cross-border DDP and IOSS integration.
