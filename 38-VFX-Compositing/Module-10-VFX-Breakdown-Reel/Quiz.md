---
title: "Module 10 Quiz: VFX Breakdown Reel & Career"
---

# 🧪 Module 10 Quiz: VFX Breakdown Reel & Career
...
What is the maximum recommended length for a professional VFX demo reel?
...
In a VFX reel, what should the first 15 seconds contain?

A. An introduction card with your name, logo, and professional social media links
B. A slow cinematic fade-in with musical atmosphere before the VFX work begins
C. Your absolute best shot, cut directly to the work with no intro
D. A title sequence naming all the films you worked on
...
C. The finished composite takes up too much file size for online submission
D. Before/after breakdowns are only required for Nuke reels, not AE reels

---

### Q4.

Which of the following is the most appropriate format for presenting a green screen integration shot in a reel?

A. Full-screen composite only, at the highest possible resolution
B. Split-screen or wipe showing the plate/raw footage on one side and the final composite on the other
C. A side-by-side comparison of four different takes of the green screen key
D. A wireframe overlay showing the mask shape used for the key

---

### Q5.

ILM (Industrial Light & Magic) was founded in what year, by whom, and for what project?

A. 1983, by James Cameron, for The Terminator
B. 1975, by George Lucas, for Star Wars
C. 1993, by Steven Spielberg, for Jurassic Park
D. 1977, by Dennis Muren, for Star Wars (as a subcontractor)

---

### Q6.

In the VFX industry, what is the primary cultural difference between ILM and a boutique studio like Crafty Apes?

A. ILM only does film; boutique studios only do TV
B. ILM artists specialize deeply in one area over long periods; boutique artists typically work as generalists across keying, roto, tracking, and finishing in the same week
C. Boutique studios pay higher rates than ILM
D. ILM uses After Effects; boutique studios use Nuke

---

### Q7.

A compositor position at a film studio (ILM, Weta FX, Framestore, MPC) reviewing your reel will typically reject it if:

A. The reel is only 90 seconds long
B. The reel shows only After Effects work with no evidence of Nuke proficiency
C. The reel includes more than 6 shots
D. The reel doesn't include motion graphics alongside VFX work

---

### Q8.

IATSE Local 839 covers which category of entertainment industry workers?

A. Directors, producers, and screenwriters
B. Animators, visual effects artists, concept artists, and storyboard artists
C. Cinematographers and camera operators
D. Post-production sound editors

---

### Q9.

What is the recommended number of shots in a professional VFX reel?

A. 1–2 shots (fewer, better quality)
B. 4–8 shots demonstrating distinct VFX skills
C. 15–20 shots to demonstrate breadth
D. As many shots as possible to maximize portfolio coverage
...
The career progression for a compositor typically follows which path?

A. Roto Artist → Paint Artist → Matte Painter → Compositor
B. Junior Compositor → Mid Compositor → Senior Compositor → Lead Compositor → VFX Supervisor
C. 3D Modeler → FX Artist → Technical Director → Compositor
D. Matchmove Artist → Compositor → Colorist → Director

---

### Q13.

Freelance VFX artists at the mid-level (2–5 years experience) typically charge what day rate range in the US market (2025–2026)?
...
At Weta FX (Wellington, New Zealand), which franchise productions have been primary VFX work?

A. Marvel Cinematic Universe and Star Wars
B. The Lord of the Rings trilogy, Avatar, Planet of the Apes series, and other major productions
C. Exclusively Disney Animation productions
D. European art-house films and independent productions

---

### Q15.

The IATSE 2023 contract was significant for VFX artists primarily because:

A. It expanded coverage to include visual effects workers for the first time
B. It represented the most significant wage increase in 15 years following collective bargaining
C. It required all VFX work to be performed within the US
D. It merged IATSE Local 839 with the SAG-AFTRA union

---

### Q16.

Which file format is recommended for VFX reel submission to maintain professional quality with manageable file size?

A. 8-bit JPEG image sequence
B. H.264/H.265 MP4 or ProRes 422 at 1920×1080 or higher
C. Uncompressed TIFF sequence at native render resolution
D. Flash video (FLV) for maximum browser compatibility
...
Which production hub for VFX work is NOT a major global VFX center in 2026?

A. London (Framestore, DNEG, MPC)
B. Wellington (Weta FX)
C. Vancouver (Image Engine, Scanline VFX)
D. Phoenix, Arizona
...
BECTU is the VFX industry union equivalent of IATSE in which country?
