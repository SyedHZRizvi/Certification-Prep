---
title: "Module 10 Videos: VFX Breakdown Reel & Career"
---

# 🎬 Module 10 Videos: VFX Breakdown Reel & Career
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=how+to+make+VFX+demo+reel+before+after+breakdown" data-video-id="reel-01">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=VFX+artist+vs+compositor+career+path+difference+explained" data-video-id="reel-02">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=ILM+VFX+career+working+at+industrial+light+magic" data-video-id="reel-03">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=freelance+VFX+artist+rates+career+how+to+get+clients" data-video-id="reel-04">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=IATSE+union+VFX+artists+animation+guild+explained" data-video-id="reel-05">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
    <div class="vg-card-title">IATSE and the Animation Guild: VFX Union Rights Explained</div>
    <div class="vg-card-meta">IATSE / industry news channel · ~14 min</div>
    <div class="vg-card-desc">What IATSE Local 839 covers, why VFX artists unionize, current minimum rates, and health/pension benefits.</div>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=VFX+reel+critique+what+not+to+do+common+mistakes" data-video-id="reel-06">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=boutique+VFX+studio+vs+major+studio+career+difference" data-video-id="reel-07">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=VFX+breakdown+reel+making+tutorial+after+effects+edit" data-video-id="reel-08">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=Weta+FX+career+New+Zealand+VFX+studio+how+to+get+job" data-video-id="reel-09">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=VFX+industry+job+market+2025+2026+streaming+Hollywood" data-video-id="reel-10">
  <div class="vg-card-thumb">🎬</div>
  <div class="vg-card-body">
