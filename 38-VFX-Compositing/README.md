...
|------|---------------|-------|
| Junior VFX Artist | $45K–$70K | Entry at boutique studios; strong reel required |
| Mid-Level Compositor | $70K–$110K | 2–4 years; Nuke proficiency critical |
| Senior Compositor | $110K–$160K | Show lead level; DI + ACES pipeline experience |
| VFX Supervisor | $150K–$250K | On-set + post; ILM / Weta / Framestore tier |
| Technical Director | $90K–$140K | Pipeline + scripting; Python/Nuke TCL |
| Freelance VFX Artist | $60–$200/hr | Broadcast, commercial, music video |

Average compensation uplift after building a professional reel: **35–55%** within 12 months, based on IATSE Local 839 wage surveys, LinkedIn Salary, and The VES (Visual Effects Society) workforce reports.
...
|---|--------|------|--------------------|
| 1 | [VFX Pipeline Overview](./Module-01-VFX-Pipeline-Overview/Reading.md) | 3.5 hrs | Pre-vis → shoot → post, departments, on-set supervision, Avengers + Mandalorian case studies |
| 2 | [Green Screen Keying](./Module-02-Green-Screen-Keying/Reading.md) | 4 hrs | Keylight, three-step key, spill suppression, difference mattes, matching plate to background |
| 3 | [Rotoscoping & Masking](./Module-03-Rotoscoping-Masking/Reading.md) | 4 hrs | Rotobrush 2.0, manual mask animation, cheat roto stack, Silhouette, color isolation |
| 4 | [Tracking: 2D, 3D & Planar](./Module-04-Tracking-2D-3D-Planar/Reading.md) | 4 hrs | AE tracker, Mocha planar, corner pin, warp stabilize, 3D camera solve, CG attachment |
| 5 | [Particle Systems in AE](./Module-05-Particle-Systems-AE/Reading.md) | 4 hrs | Trapcode Particular, physics simulation, custom shapes, CC Particle World, fire/smoke/magic |
| 6 | [Nuke Fundamentals](./Module-06-Nuke-Fundamentals/Reading.md) | 5 hrs | Node graph paradigm, core nodes, multi-channel EXR, Viewer, why Nuke dominates film VFX |
| 7 | [Color Grading](./Module-07-Color-Grading/Reading.md) | 4 hrs | Color science, log vs linear, LUTs, ACES, primary/secondary, shot matching, Oppenheimer case study |
| 8 | [Practical Digital FX](./Module-08-Practical-Digital-FX/Reading.md) | 4 hrs | Practical + digital integration, set extensions, sky replacement, wire removal, cleanup |
| 9 | [Destruction & Action FX](./Module-09-Destruction-Action-FX/Reading.md) | 4.5 hrs | Explosion layer stack, muzzle flashes, lens effects, Blender sims into AE comp |
| 10 | [VFX Breakdown Reel](./Module-10-VFX-Breakdown-Reel/Reading.md) | 3.5 hrs | Reel structure, ILM vs boutique careers, IATSE union, freelance rates |

**Total study time:** ~41 hours of reading + 14 hours of videos + 12 hours of quizzes/exams = **~67 hours**.
...
|------|-----------------|-----------|------|------------|
| [Practice-Exam-1](./Practice-Exams/Practice-Exam-1.md) | After Modules 1–5 | 30 | 60 min | ⭐⭐⭐ |
| [Practice-Exam-2](./Practice-Exams/Practice-Exam-2.md) | After Modules 6–10 | 30 | 60 min | ⭐⭐⭐⭐ |
| [Final-Mock-Exam](./Practice-Exams/Final-Mock-Exam.md) | Final week before portfolio review | 65 | 90 min | ⭐⭐⭐⭐⭐ |
...
| Tool | Version | Role |
|------|---------|------|
| Adobe After Effects | 2025 (v25.x) | Primary compositing, motion graphics, particles |
| Foundry Nuke | 15.x (Non-Commercial free) | Professional node-based compositing |
| Blender | 4.x | 3D elements, destruction sims, camera solves |
| Mocha AE | Bundled with AE | Planar tracking, rotoscoping |
| Trapcode Particular | 6.x | Particle systems (Maxon/Red Giant suite) |
| DaVinci Resolve | 19.x | Color grading, final output |
| Silhouette | 2024 | Professional rotoscoping |
...
6. ❌ **Generic effects.** Stock explosions, default lens flares, plugin-of-the-week aesthetics. Module 9 teaches building effects from layered elements.
...
Before you submit your reel:

- [ ] All 10 module Quizzes scored ≥20/24 or equivalent
- [ ] Practice Exam 1: ≥22/30
- [ ] Practice Exam 2: ≥23/30
- [ ] Final Mock Exam: ≥49/65
- [ ] Flashcards: ≥80% marked "Got it"
- [ ] All 10 Cheat-Sheets re-read in the past week
- [ ] You can pull a clean Keylight key on a difficult subject (hair or glass) from memory
- [ ] You have at least one Nuke comp in your reel
- [ ] Your reel opens with your best shot in the first 15 seconds
- [ ] You can articulate what a VFX pipeline looks like from plate delivery to final output

---

## 🎬 Start Here

👉 [**Module 1: VFX Pipeline Overview**](./Module-01-VFX-Pipeline-Overview/Reading.md)

The work that makes impossible things look real starts here.
