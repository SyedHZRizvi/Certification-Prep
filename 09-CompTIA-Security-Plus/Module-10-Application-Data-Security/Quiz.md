...
### Q3. SCA (Software Composition Analysis) finds:
...
### Q4. Which testing technique sends malformed inputs to find crashes / edge-case failures?
A. SAST
B. DAST
C. SCA
D. Fuzzing
...
### Q5. RASP differs from DAST because:
...
### Q8. Which Sec+ data state is BEST protected by TLS?
A. At rest
B. In transit
C. In use
...
### Q9. "Confidential computing" addresses which data state?
A. At rest
B. In transit
C. In use
D. Backup
...
### Q10. Which technique replaces sensitive data with a token, with no mathematical relationship between the two?
A. Hashing
B. Encryption
C. Tokenization
D. Masking
...
### Q11. Showing `****1234` for the last 4 digits of a credit card is:
A. Hashing
B. Tokenization
C. Masking
D. Encryption
...
### Q12. Under GDPR, "anonymization" is:
...
### Q13. Pseudonymization differs from anonymization because:
...
### Q14. STRIDE includes which of the following?
...
### Q15. Which is the BEST defense against SQL injection?
...
### Q16. A pipeline should fail the build when which condition is detected?
...
### Q17. The MOST appropriate location to store database passwords used by an app is:
...
### Q18. Which data classification typically applies to credit card data?
A. Public
B. Internal
C. PCI / CHD
D. PHI
...
### Q21. Network DLP would BEST detect:
...
### Q22. Endpoint DLP would BEST detect:
...
### Q23. Which is required by US Executive Order 14028 for federal software?
A. CCPA compliance
B. SBOM
C. PCI-DSS
...
### Q24. Which language is generally considered MEMORY-UNSAFE by default?
A. Rust
B. Go
C. C / C++
D. Python
...
### Q25 (Scenario). A microservice is exposed to the internet. SAST shows 0 critical findings; SCA finds a Log4Shell-vulnerable library. The CORRECT immediate action is:
...
### Q26 (Scenario). A team wants to share customer purchase data with a research vendor. The vendor needs to compute aggregate statistics but should NEVER be able to re-identify individuals. BEST approach:
A. Send raw PII
