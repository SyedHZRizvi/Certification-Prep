...
| **EDR** | Behavioral + telemetry + threat hunt + rollback |
| **XDR** | EDR + network + cloud + email correlated |
...
| **CWPP** | Runtime VM/container protection |
| **CIEM** | IAM entitlements right-sizing |
| **SASE** | SD-WAN + cloud sec services |
| **SSE** | SASE minus SD-WAN |
| **ZTNA** | Identity-aware app access (replaces VPN) |
...
- IaC: pre-commit secret scan; Checkov / tfsec for policy
