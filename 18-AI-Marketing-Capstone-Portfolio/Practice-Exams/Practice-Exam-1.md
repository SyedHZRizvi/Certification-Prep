# 🧪 Mid-Program Portfolio Review (After Capstones 1–4)

> **Conditions:** Set a 60-minute timer. 40 self-evaluation questions. Treat it like a real portfolio review.
> **Pass mark:** 32/40 (80%) graded as Excellent or Solid (see grading guidance below).
> Take this AFTER finishing Modules 1–5 (Strategy + SEO Audit + Paid Campaign + Automation + Attribution).
...
> Unlike traditional exams, every question above has a "best" answer (A in most cases). The model answers below describe what excellent looks like. Use this as a self-grading guide.

```
Q1: A    Q11: A    Q21: A    Q31: A
Q2: A    Q12: A    Q22: A    Q32: A
Q3: A    Q13: A    Q23: A    Q33: A
Q4: A    Q14: A    Q24: A    Q34: A
Q5: A    Q15: A    Q25: A    Q35: A
Q6: A    Q16: A    Q26: A    Q36: A
Q7: A    Q17: A    Q27: A    Q37: A
Q8: A    Q18: A    Q28: A    Q38: A
Q9: A    Q19: A    Q29: A    Q39: A
Q10: A   Q20: A    Q30: A    Q40: A
```

> Each "A" represents the "Excellent" benchmark for that question. The grading guidance below describes what passing answers (B) look like, and where you should put work if you scored C or D.

### Grading Guidance Per Question

**Q1 (Path)**: Excellent = path written + 1-sentence reasoning + target outcome. Vagueness here cascades into vague capstones.

**Q2 (Subjects)**: Real subjects = real businesses with names, links, confirmed shareability. "I'll find one" is the most common failure pattern.

**Q3 (P-C-A-R-L)**: Excellent = every capstone uses this exact structure. Consistency = trust.
...
**Q7 (Campaign runtime)**: 14+ days is non-negotiable. Less = algorithm hasn't learned.

**Q8 (Campaign spend)**: $180-220 range. Real money is the credibility.

**Q9 (Failures)**: Featured prominently. Hiding failures = lowest-trust signal.

**Q10 (Post-mortem length)**: 1,500-2,500 words. Calibrated for marketing reads.

**Q11 (Automation steps)**: 5+ steps + router = systems thinking demonstrated.

**Q12 (Loom)**: Live execution shown = "show don't tell" applied.

**Q13 (JSON export)**: Sanitized + public = the GitHub-repo equivalent for automation.

**Q14 (Attribution models)**: 3+ models = comparison is the punchline.

**Q15 (Sample size)**: 100+ journeys = Markov has signal.

**Q16 (Chart)**: Clustered bar chart = money shot. Without it, no insight.

**Q17 (Portfolio site)**: Live + linkable. Otherwise nothing exists.

**Q18 (Hero images)**: Visual hook on every case study page.

**Q19 (LinkedIn post)**: Posted is half the value. Drafts don't count.

**Q20 (Testimonial)**: Subject's 2-line quote on the case study page. Gold.

**Q21 (3-min readability)**: Peer-test it. Adjust if not clear.

**Q22 (AI tools)**: Used + disclosed = 2026 best practice.

**Q23 (Time spent)**: 30-40 hours for 4 capstones. Calibrated.

**Q24 (Polish trap)**: Notion shipped beats Webflow forever-iterated.

**Q25 (Cold descriptions)**: 90-sec pitch ready for each.

**Q26 (Practice)**: Out loud. 5+ times.

**Q27 (Lessons)**: Specific honest lessons per capstone. Builds trust.

**Q28 (Headline)**: Capstone-anchored format. Drives clicks to Featured.

**Q29 (PII)**: Anonymized. Most common privacy fail.

**Q30 (Audit accessibility)**: Public link or PDF download.

**Q31 (Attribution sharing)**: Sheet/notebook on public access.

**Q32 (Architecture diagram)**: Visual = 5x more memorable.

**Q33 (Defending choices)**: Can articulate every decision.

**Q34 (Cost tracking)**: Senior-marketer signal.

**Q35 (Deadlines)**: Self-imposed + hit = professional muscle.

**Q36 (Peer review)**: Caught blind spots.

**Q37 (Screenshots)**: Clean, labeled, large.

**Q38 (90-sec scan)**: Verified by friend test.

**Q39 (Tools list trap)**: Work-first, not tools-list.

**Q40 (Ready for Module 6)**: Genuinely yes, no avoidance.
...
| Score | Verdict |
|-------|---------|
| 36–40 A's | 🏆 Strong mid-program portfolio. Push into Module 6 immediately. |
| 28–35 A's + B's | ✅ Solid. Fix the C/D items in the next 3 days, then continue. |
| 20–27 A's | ⚠️ Half-finished portfolio. Take 1 week to fix gaps before Module 6. |
| <20 A's | 🔁 Capstones need more work. Re-do the weakest one before continuing. |
...
4. Re-take this exam in 1 week

The portfolio is only as strong as its weakest piece. If 1 capstone is at "Failing," that piece will hurt your overall positioning. Better to fix it than to ship 5 inconsistent pieces.
...
**Why the other options fall short.**
- **B ($150–$179 or $221–$250)**: Within tolerance, still a real campaign. Slightly under-budget = less data; slightly over = scope creep.
...
- **C (In progress)**: Almost always a sign of perfectionism. Ship the Notion version today; polish later.
- **D (Not built)**: Module 7 wasn't completed. The whole portfolio system collapses without the wrapper.

**Exam-takeaway.** Public > polished. A live Notion site beats a 95%-done Webflow draft every time.
...
- **C (Plan to use)**: Means you didn't actually use it. In a 6-week portfolio sprint, "plan to" usually = "won't."
- **D (Avoided)**: Worst signal. Suggests you're either resistant to modern tooling, or unaware of where the industry is.

**Exam-takeaway.** Modern marketing is AI-augmented. "Built with Cursor + 70% AI-generated code" or "Hero images created in Midjourney" are now strength signals when disclosed honestly.
...
- **C (Roughly)**: A senior interviewer will press until you crack.
- **D (Not confident)**: Indicates you may have used a library without understanding it. Big senior tell.

**Exam-takeaway.** The "why this method" question is the analytical-depth check. Have a 60-second answer ready, with the trade-offs named.
...
➡️ When ready: [Practice Exam 2: Full Portfolio Review](./Practice-Exam-2.md)
