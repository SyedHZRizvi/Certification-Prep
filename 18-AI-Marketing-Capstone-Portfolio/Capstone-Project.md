...
## The 8 Deliverables (One Per Module)

Each module's `Reading.md` describes the deliverable in full detail. This is the at-a-glance summary:
...
| **The "single link" test** | 8 | One Notion / Read.cv / Webflow link tells the whole story in 5 minutes | Single link exists but takes 10+ minutes | No single hub; portfolio scattered across platforms |
| **Recruiter-readiness assessment score** | 8 | 90%+ on the Module 8 Recruiter Readiness Assessment | 80-89% on the assessment | <80% on the assessment |

**Pass mark:** 75/100 overall. Anything below 70 means the portfolio is not yet ready to send. Iterate on the lowest 2-3 criteria before pitching.
...
WEEK 1   →  Module 1 (Portfolio Strategy)
            ✓ Project list locked + case-study template chosen
...
- [ ] LinkedIn About section opens with the problem you solve, not your bio
- [ ] LinkedIn Featured section has all 5 capstone case studies linked
- [ ] Portfolio site exists at a clean URL (custom domain or notion.so/yourhandle)
- [ ] Portfolio site loads in <3 seconds and is mobile-readable
- [ ] First 30 posts live on LinkedIn over the past 21 days

**Capstone Artifacts (Modules 2-6)**
- [ ] SEO audit (Module 2) is a real audit of a real business, 15+ pages, with a 90-day roadmap
- [ ] Paid campaign (Module 3) has documented actual spend + actual metrics + actual post-mortem (not "what I would have done")
- [ ] Automation workflow (Module 4) has a working JSON export anyone could import + a Loom walkthrough
- [ ] Attribution model (Module 5) is a public link (Sheets, Colab, GitHub) with the math actually executed, not described
- [ ] AI agent (Module 6) is deployed and runnable, with a GitHub repo a stranger could clone

**Storytelling and Failure Narrative**
- [ ] Each case study has a "what broke" section explicitly
- [ ] Each case study has a "what I'd do differently" section explicitly
- [ ] Each case study has at least 2 specific numbers (spend, CTR, CVR, ROAS, time, dollars)

**First-Client Motion (Module 8)**
- [ ] ICP is locked (firmographic + persona + anti-ICP)
- [ ] Cold outreach deck is built and you can speak to it in 90 seconds
- [ ] At least 5 cold messages have been sent to real prospects
- [ ] Follow-up cadence is scheduled (Day 3 / Day 7 / Day 14)

**Recruiter Readiness Assessment**
- [ ] Score on the Module 8 assessment is 90%+
- [ ] 3 friendly colleagues have given you unfiltered feedback on the single-link portfolio
- [ ] You've fixed the top 2 things they flagged
...
## Pointers to the Work Itself

Every module in this course has 4 files. To do the actual capstone work, read each module's `Reading.md` and `Cheat-Sheet.md`, watch the videos in `Videos.md`, and use the Quiz + Practice Exam to self-evaluate.

- **Module 1:** [Reading](./Module-01-Portfolio-Strategy-What-To-Build/Reading.md) · [Cheat Sheet](./Module-01-Portfolio-Strategy-What-To-Build/Cheat-Sheet.md) · [Quiz](./Module-01-Portfolio-Strategy-What-To-Build/Quiz.md) · [Videos](./Module-01-Portfolio-Strategy-What-To-Build/Videos.md)
- **Module 2:** [Reading](./Module-02-Capstone-SEO-Content-Audit/Reading.md) · [Cheat Sheet](./Module-02-Capstone-SEO-Content-Audit/Cheat-Sheet.md) · [Quiz](./Module-02-Capstone-SEO-Content-Audit/Quiz.md) · [Videos](./Module-02-Capstone-SEO-Content-Audit/Videos.md)
- **Module 3:** [Reading](./Module-03-Capstone-Paid-Campaign-Live/Reading.md) · [Cheat Sheet](./Module-03-Capstone-Paid-Campaign-Live/Cheat-Sheet.md) · [Quiz](./Module-03-Capstone-Paid-Campaign-Live/Quiz.md) · [Videos](./Module-03-Capstone-Paid-Campaign-Live/Videos.md)
- **Module 4:** [Reading](./Module-04-Capstone-Marketing-Automation-Workflow/Reading.md) · [Cheat Sheet](./Module-04-Capstone-Marketing-Automation-Workflow/Cheat-Sheet.md) · [Quiz](./Module-04-Capstone-Marketing-Automation-Workflow/Quiz.md) · [Videos](./Module-04-Capstone-Marketing-Automation-Workflow/Videos.md)
- **Module 5:** [Reading](./Module-05-Capstone-Attribution-Model-Spreadsheet/Reading.md) · [Cheat Sheet](./Module-05-Capstone-Attribution-Model-Spreadsheet/Cheat-Sheet.md) · [Quiz](./Module-05-Capstone-Attribution-Model-Spreadsheet/Quiz.md) · [Videos](./Module-05-Capstone-Attribution-Model-Spreadsheet/Videos.md)
- **Module 6:** [Reading](./Module-06-Capstone-AI-Agent-Build/Reading.md) · [Cheat Sheet](./Module-06-Capstone-AI-Agent-Build/Cheat-Sheet.md) · [Quiz](./Module-06-Capstone-AI-Agent-Build/Quiz.md) · [Videos](./Module-06-Capstone-AI-Agent-Build/Videos.md)
- **Module 7:** [Reading](./Module-07-Personal-Brand-Online-Presence/Reading.md) · [Cheat Sheet](./Module-07-Personal-Brand-Online-Presence/Cheat-Sheet.md) · [Quiz](./Module-07-Personal-Brand-Online-Presence/Quiz.md) · [Videos](./Module-07-Personal-Brand-Online-Presence/Videos.md)
