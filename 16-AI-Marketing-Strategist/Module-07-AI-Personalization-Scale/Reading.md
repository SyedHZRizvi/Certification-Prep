...
> - The predictive-model vocabulary from [Module 6: Predictive Analytics CLV (Customer Lifetime Value), Churn & Propensity](../Module-06-Predictive-Analytics-LTV (Lifetime Value)-Churn/Reading.md) collaborative filtering and recsys share the same model-evaluation toolkit.
> - The first-party event-stream architecture from [Module 2](../Module-02-CDP (Customer Data Platform)-Server-Side-Tracking/Reading.md), personalization is only as good as the events that feed it.
...
| **MAP (Minimum Advertised Price) @ K** | Mean Average Precision, penalizes order errors | Balanced |
...
| **Amazon Personalize** | AWS (Amazon Web Services)-native | Managed recsys |
...
- Headline copy generated by GPT (Generative Pre-trained Transformer)-4 / Claude / Gemini that references "since you bought the X jacket, here's the matching pants…"
