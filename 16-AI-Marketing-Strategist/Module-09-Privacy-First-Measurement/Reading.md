...
> If you've never seen a Consent Management Platform (CMP) banner or a CCPA (California Consumer Privacy Act) "Do Not Sell" link in action, spend 15 minutes on a few major DTC (Direct-to-Consumer) sites before continuing.
...
A variant for B2B (Business-to-Business)/lead-gen advertisers, when a lead converts in your CRM (Customer Relationship Management) (not on-site), you can upload the hashed lead identifier back to Google Ads to retroactively attribute the lead to its original ad click.
...
|------------------|--------------|------------------|
| **GDPR (General Data Protection Regulation)** (2018) | EU + EEA + UK | Processing personal data without lawful basis; mandates consent, DSAR, DPA |
