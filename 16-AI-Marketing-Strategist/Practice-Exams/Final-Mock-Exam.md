...
C. Stakeholders, Touchpoints, Personas
D. Sustainability, Trust, Promise

### 2. ISADA criteria for a valid market segment include all EXCEPT:
A. Identifiable
B. Substantial
C. Inexpensive
D. Accessible

### 3. In Doerr's OKR framework, well-formed OKR attainment range is:
A. 100% consistently
B. None defined
C. 25–50%
D. 50–70% (sandbagged if always 100%)
...
### 5. The Spotify Wrapped strategy combined:
A. SWOT + PESTEL + BCG
B. RFM + AARRR + AIDA
C. Ansoff + Porter + 4Ps
D. JTBD + STP + OKR design

### 6. Porter's Five Forces include:
A. Entrants, suppliers, buyers, substitutes, rivalry
B. Reach, frequency, impressions, CTR, CVR
C. Plan, do, check, act, repeat
D. Strength, weakness, opportunity, threat, environment

### 7. In Ansoff, new product into existing market is:
A. Product development
B. Market development
C. Penetration
D. Diversification

### 8. BCG "Question Mark" has:
A. High share, high growth
B. High share, low growth
C. Low share, low growth
D. Low share, high growth

### 9. JTBD's four switching forces:
A. Awareness, interest, desire, action
B. Plan, do, check, act
C. Push, pull, anxiety, habit
D. Reach, frequency, engagement, conversion

### 10. The North Star of Facebook (in 2007) was famously:
A. Sign-ups
B. Friend-7-days (users with 7+ friends in 10 days)
C. Daily active users
D. Revenue

### 11. A CDP's 5 properties (per the CDP Institute) include all EXCEPT:
A. Packaged software
B. Persistent unified DB
C. Accessible to other systems
D. Real-time bidding capability

### 12. The 4 CDP architectural patterns:
...
### 14. Apple's iOS App Tracking Transparency (ATT) opt-in rates settled around:
A. 5–10%
B. >90%
C. 50–70%
D. 25–35%

### 15. Server-side tagging typically recovers what fraction of measurement loss?
A. ~100%
B. 60–80%
C. 5–25%
D. None

### 16. Stape.io is BEST described as:
A. A reverse-ETL tool
B. A data warehouse
C. Managed hosting + power-ups for server-side GTM
D. A DMP

### 17. Probabilistic identity resolution is being RESTRICTED in 2026 because:
A. Regulators treat it as "tracking" requiring consent
B. Too expensive
C. Accuracy dropped
D. CDPs no longer support it

### 18. In GA4, the atomic unit of data is:
A. Session
B. Pageview
C. User property
D. Event

### 19. UA stopped collecting data on:
A. July 1 2023
B. Dec 31 2020
C. Jan 1 2024
D. July 1 2024

### 20. Maximum parameters per GA4 event:
A. 10
B. 25
C. 50
D. 100

### 21. Free-GA4 custom-dimension limit:
A. 10
B. 25
C. 50
D. 100

### 22. Max Key Events per GA4 property:
A. 25
B. 50
C. 30
D. 100

### 23. "Engaged session" is defined as:
A. >10s OR conversion OR 2+ screens/pages
B. >5s
C. >60s only
D. Has purchase only

### 24. GA4's identifier priority order:
A. Device > Google > User > Modeled
B. User ID > Google Signals > Device ID > Modeled
C. Modeled > Device > Google > User
D. Random

### 25. GA4 free-tier event-level data retention default is:
A. 6 months
B. 50 months
C. Forever
D. 2 months (raise to 14)

### 26. GA4 BigQuery export is:
A. Paid for both
B. 360-only
C. Free for both free GA4 and 360
D. Not available

### 27. GA4 DDA model requires:
A. 100 conversions/month
B. 400 conversions per type / 30 days
C. 10K/year
D. No minimum

### 28. To extract a parameter in BigQuery SQL on GA4 schema:
...
### 29. Three GA4 predictive metrics:
A. Visit, click, scroll
B. RFM, LTV, CAC
C. CTR, CVR, ROAS
D. Purchase probability, churn probability, predicted revenue

### 30. Last-click attribution typically OVER-credits:
A. Bottom-funnel, click-driven channels
B. Brand channels
C. Offline
D. Untrackable

### 31. Shapley value attribution distributes credit by:
A. Final touch only
B. Average marginal contribution across all orderings
C. Equal split
D. Linear regression

### 32. Markov-chain attribution uses:
A. Hill saturation
B. K-means
C. SHAP
D. Removal effect on conversion probability

### 33. SHAP is BEST described as:
A. ML interpretability built on Shapley axioms, used for non-linear models
B. The same as Shapley
C. A vendor brand
D. Regression diagnostic

### 34. SKAdNetwork (SKAN) is:
A. Open-source library
B. Google product
C. Meta product
D. Apple's privacy-preserving iOS install attribution framework

### 35. AppsFlyer, Branch, Adjust are:
A. CDPs
B. Mobile Measurement Partners (MMPs)
C. DMPs
D. MMM tools

### 36. The 2026 measurement triangle is:
A. Email + Display + Search
B. MTA + MMM + Incrementality
C. Pixel + Cookie + Server
D. CTR + CVR + ROAS

### 37. Ad-stock half-life when λ = 0.5 is:
A. 0.5 weeks
B. 2 weeks
C. 1 week
D. 4 weeks

### 38. Hill saturation function:
A. `e^(-x)`
B. `a + b·x`
C. `x^α / (x^α + K^α)`
D. `log(x)`

### 39. Robyn is built in:
A. R (with Python port in dev)
B. Python only
C. Excel
D. Java
...
### 40. Meridian uses:
A. R
B. Python + TensorFlow Probability
C. SAS
D. Stata

### 41. Bayesian MMM gives you:
A. Posterior distributions over parameters
B. Single point estimates
C. Only frequentist p-values
D. Categorical labels

### 42. Calibrating an MMM means:
A. Tuning colors
B. Constraining coefficients using incrementality test ground truth
C. Re-running daily
D. Adding more channels

### 43. Baseline in MMM decomposition typically represents:
A. 5–15%
B. 50–80%
C. >95%
D. Always 50%
...
### 45. Customer Lifetime Value (CLV) is:
A. Annual revenue per customer
B. Lifetime MRR
C. First-year revenue only
D. Total revenue/profit expected over the customer's relationship with the business

### 46. The simple CLV formula AOV × Freq × Lifespan × Margin works best for:
A. All businesses
B. Non-contractual e-commerce
C. Contractual / steady-state businesses (subscriptions)
D. B2B only

### 47. BG/NBD is associated with:
A. Fader & Hardie
B. Kahneman & Tversky
C. Pareto & Hardie
D. Christensen & Moore

### 48. The "B" in BG/NBD is:
A. Bayesian
B. Beta (dropout prior)
C. Binomial
D. Block

### 49. BG/NBD's companion model for monetary value:
A. Beta-Bernoulli
B. Hill-Saturation
C. Gamma-Gamma
D. Markov-Chain

### 50. Canonical Python library for BG/NBD + Gamma-Gamma:
A. scikit-learn
B. tensorflow
C. lifetimes
D. pytorch

### 51. An operationally useful churn model AUC bar:
A. >0.55
B. >0.80
C. =1.0
D. AUC doesn't matter

### 52. Calibrating a LightGBM probability uses:
A. Random sampling
B. Z-score normalization
C. Isotonic regression or Platt scaling
D. Min-max scaling

### 53. The four uplift segments:
A. Stars, Cash Cows, Question Marks, Dogs
B. Champions, Loyal, At-Risk, Lost
C. Persuadables, Sure Things, Lost Causes, Do-Not-Disturbs (Sleeping Dogs)
D. Push, Pull, Anxiety, Habit

### 54. Marketing to "Sure Things" is:
A. Best practice
B. Required by GDPR
C. Wasted impressions
D. The default for Meta

### 55. Production-default bandit algorithm in 2026:
A. ε-greedy
B. UCB
C. Thompson Sampling
D. Random
...
### 57. Matrix factorization decomposes:
A. User × item rating matrix into latent-factor matrices
B. Time series
C. Transition matrix
D. Customer journey

### 58. Netflix Prize was won using:
A. Deep neural network
B. Ensemble dominated by matrix factorization
C. Item-item CF only
D. K-means

### 59. Two-tower recsys model:
A. Separate user and item networks producing embeddings, scored by similarity
B. Two attention heads
C. CNN + RNN
D. Linear + logistic

### 60. Meta's production recsys architecture is:
A. PinSage
B. RecBole
C. BERT4Rec
D. DLRM (Deep Learning Recommendation Model)

### 61. Optimizing only for NDCG tends to cause:
A. Better serendipity
B. Improved cold start
C. Higher diversity
D. Filter bubbles + popularity bias

### 62. M0 in a cohort matrix means:
A. Current month
B. First month after acquisition
C. The month of acquisition
D. Last observation

### 63. The three canonical retention shapes:
A. L-curve, smile, cliff
B. Bell, normal, skewed
C. Linear, exponential, logarithmic
D. Monthly, weekly, daily

### 64. NRR formula:
A. (this quarter) / (last quarter)
B. (start ARR + expansion − contraction − churn) / start ARR
C. CLV / CAC
D. (start MRR) / (end MRR)

### 65. Best-in-class B2B SaaS NRR is approximately:
A. >50%
B. >120%
C. <60%
D. =100%

### 66. Meta's Advantage+ Audience is BEST described as:
A. ML-driven 2024+ replacement for manual look-alikes
B. The same as Custom Audience
C. Mandated by GDPR
D. A type of CDP

### 67. The "death spiral" pre-churn pattern shows:
A. Sudden cancellation, no warning
B. Gradual usage decline in the weeks before churn
C. Random pattern
D. Inverse correlation with revenue

### 68. The 4 Consent Mode v2 parameters include all EXCEPT:
A. session_storage
B. ad_user_data
C. ad_personalization
D. ad_storage

### 69. Advanced Consent Mode differs from Basic in:
A. Cost
B. Advanced requires 360
C. Basic is EU-only
D. In Advanced, anonymized pings fire when consent is denied → Google models lost conversions

### 70. CAPI deduplication uses keys:
A. event_name only
B. event_id + event_name + event_time + fbc/fbp
C. server timestamp only
D. random sampling

### 71. SKAdNetwork conversion-value bits:
A. 1
B. 8
C. 6 (0–63)
D. 16

### 72. Chrome's Topics API assigns:
A. Per-user emails
B. ~3 weekly topics from a 470-topic taxonomy
C. Random cookies
D. None of the above

### 73. A data clean room is:
A. A privacy-preserving multi-party query environment without raw data exchange
B. A physically secure server
C. A type of CDP
D. A vendor of pixels

### 74. 2026 default marketing org structure for $10M–$1B revenue:
A. Centralized
B. Outsourced
C. Federated
D. Hub-and-spoke

### 75. The 5 CFO questions to a marketing strategist include all EXCEPT:
A. "What did we spend and what did it return?"
B. "How do you know it's incremental?"
C. "Where is the next $X going?"
D. "What's the CEO's favorite metric?"
...
| Score | Verdict |
|-------|---------|
| 70–75 | 🏆 Top-tier. Schedule the real cert and book your next role. |
| 60–69 | ✅ Pass-quality. Review weak areas + take notes. |
| 50–59 | ⚠️ Close. Re-study weak modules. Retake in 5 days. |
| <50 | 🔁 Re-read the weak modules systematically. |
