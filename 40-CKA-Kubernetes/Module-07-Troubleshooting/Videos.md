# 🎬 Module 7: Troubleshooting — Video Resources

> **30% of the CKA exam.** These videos build systematic diagnostic skill — watch Essential before your first practice exam, Recommended before the real exam, Optional for deep mastery.
...
<a class="vg-card" href="https://www.youtube.com/results?search_query=kubernetes+metrics+server+kubectl+top+nodes+pods+install" data-video-id="6v_BDHIgOY8">
  ...
  <div class="vg-meta">
    <span class="vg-tag optional">Optional</span>
    <p class="vg-title">metrics-server Setup and kubectl top Commands</p>
    <p class="vg-creator">TechWorld with Nana</p>
