...
> **Pass mark:** 38/50 (75%)
> Take this AFTER finishing all 8 modules + Practice Exams 1 & 2.

---

## 📝 Questions

### 1. The single most important decision in Year 1 of an AI-marketing agency is:
A. Choosing accounting software
B. Buying the most expensive AI tools
C. Selecting your wedge / niche
D. Hiring a sales rep

### 2. Brett Williams's Designjoy is the canonical example of:
A. A bootstrapped 50-person agency
B. A failed Series B
C. A one-person ~$1.5M ARR productized service at ~70% margin
D. A pivot to enterprise

### 3. The Justin Welsh content engine produces approximately:
A. 5 LinkedIn posts/week + weekly newsletter, ~8 hr/week
B. 1 LinkedIn post/year
C. 50 posts/day
D. Only podcasts

### 4. The 100/10/1 niche test consists of:
A. 100 leads, 10 calls, 1 close
B. 100 hours of training, 10 clients, 1 testimonial
C. 100 named companies, 10 watering holes, 1 painful shared problem
D. 100 channels, 10 deliverables, 1 product

### 5. Year-2 niched solo operator income typically ranges:
A. $20K–$40K
B. $180K–$420K
C. $5M–$15M
D. Always exactly $1M

### 6. The 5 Fixed Anchors of a productized service are:
A. Scope, Price, Process, Time, Outcome
B. Scope, Margin, Process, Tools, People
C. Scope, Speed, Margin, Tools, Process
D. Scope, Revenue, Cost, Margin, Profit

### 7. AI leverage is the:
A. Output multiplier from inserting AI into delivery steps
B. Number of AI tools owned
C. AI's accuracy rating
D. The number of AI subscriptions

### 8. The "audit-as-wedge" pattern (e.g., Workshop Digital) typically converts ~what % of audits to retainers?
A. 5%
B. 40%
C. 95%
D. 100%

### 9. The reading recommends Year-1 SKU expansion of:
A. 10 SKUs in Year 1
B. 1 SKU Yr 1, 2 SKUs Yr 2, 3 SKUs Yr 3
C. 50 SKUs to cover the market
D. Never add a second SKU

### 10. A productized service should target gross margin of:
A. 60–80%
B. 40–55%
C. 10–30%
D. 95–100%

### 11. The 7 client acquisition channels include all of the following EXCEPT:
A. Cold call billboards
B. Inbound
C. Outbound
D. Paid ads

### 12. The Year-1 channel default pair is:
A. Outbound + Inbound
B. Paid + Events
C. All seven
D. Referrals only

### 13. The PVCC cold email structure stands for:
A. Personal-Value-Confidence-Close
B. Prospect-Volume-Cadence-Conversion
C. Position-Vehicle-Cost-Conversion
D. Problem-Value-Credibility-Call

### 14. The outbound math benchmark (1,000 sends) yields approximately:
A. 1,000 closes
B. 50 closes
C. 1 close max
D. 30 positive replies → 13 booked → 9 shows → 2 closes (~$10K revenue at $5K avg ACV)

### 15. Cold email under ~110 words with PVCC structure converts how much better than long consultative emails?
A. About the same
B. 50x better
C. Roughly 2–4x better
D. Slightly worse

### 16. Paid ads typically profit on offers above what ACV?
A. $7,500
B. $1,000
C. $200
D. $1M

### 17. The reading suggests a Year-3 community contribution to revenue can reach:
A. 0%
B. Always 100%
C. 30–50% (with top 10% at 60–80%)
D. Always 1%

### 18. The 5 pricing mindsets include all of the following EXCEPT:
A. Price the outcome, not the time
B. Never quote on the call
C. Always be lowest in the market
D. Anchor first, then price

### 19. The "good-better-best" pricing structure typically has buyers picking the middle option:
A. 10%
B. 30%
C. 95%
D. 60–70%

### 20. The ROI projection section of a proposal exists primarily to:
A. Add page count
B. Satisfy compliance
C. Document methodology
D. Anchor the buyer on value far exceeding price

### 21. Recommended payment terms for a $5,000 productized audit:
A. Quarterly in arrears
B. Net 60
C. Net 90
D. 100% upfront

### 22. A "kill fee" clause is typically:
A. 0% of unbilled balance
B. 25–50% of unbilled balance, paid by client if they cancel mid-engagement
C. 100% always
D. Optional

### 23. Liability caps in service contracts are commonly set at:
A. Fees paid in the last 6–12 months
B. Unlimited
C. $1
D. $1B

### 24. Year-1 solo tech stack target monthly cost is approximately:
A. $25/mo
B. $200/mo
C. $1,500/mo
D. $5,000/mo

### 25. The 4-question subscription test asks all of the following EXCEPT:
A. Does it enable a billable workflow?
B. Is there a cheaper substitute?
C. Do I use it 3+ times/week?
D. Did a competitor recommend it?

### 26. The recommended Year-1 LLM choice for a solo founder:
A. ChatGPT Team minimum 5 seats
B. Self-hosted Llama only
C. Gemini Advanced only
D. ChatGPT Plus OR Claude Pro at $20/mo + free secondary

### 27. For most agency operators, the right automation tool by volume is:
A. Zapier always
B. None
C. Custom code only
D. Make.com sweet spot; n8n self-hosted at high volume; Zapier for hard connectors

### 28. The "sucker stack" Year 1 includes:
A. Notion Free
B. HubSpot Marketing Hub Pro / ZoomInfo / Salesforce
C. HubSpot CRM Free
D. Apollo Basic

### 29. The reading's tool-spend benchmark as % of revenue is:
A. 0%
B. 10–20%
C. 1–2%
D. 50%

### 30. The 3 legitimate hiring triggers include all of the following EXCEPT:
A. Sustained 50+ hr/wk for 8+ weeks with overflow
B. Wanting to "look established"
C. Specific bottleneck task >15 hr/wk
D. Active inbound prospects being turned away

### 31. The DECIDING step in the AI-native interview funnel is:
A. The application screen
B. The 30-min intro call
C. The PAID work-sample test (2–4 hours, real task)
D. The final call

### 32. Work-sample tests outperform behavioral interviews by approximately:
A. About the same
B. Identical
C. 10x worse
D. 2–3x in predicting performance

### 33. The AI-native operator profile includes all EXCEPT:
A. Daily AI usage
B. Loves shipping fast
C. Async-first communicator
D. Refuses to use AI (the "I'm a real writer" position)

### 34. International full-time hires are typically engaged through:
A. Personal Venmo
B. Cash via wire
C. Crypto
D. An EOR like Deel, Remote.com, or Multiplier

### 35. The AI-leverage multiplier target per hire vs. 2020 baseline is:
A. No improvement
B. 3–5x output
C. 100x
D. Slower output

### 36. The "tax bucket" rule says:
A. Transfer ~30% of every business deposit immediately to a tax savings account
B. Save 10% annually
C. Wait until April
D. Pay annually

### 37. US quarterly estimated tax deadlines are:
A. Monthly
B. Annually
C. April 15, June 15, Sept 15, Jan 15 (next year)
D. Random

### 38. An S-corp election typically:
A. Eliminates all taxes
B. Lets you pay $0 salary
C. Splits owner pay into reasonable salary + distributions, saving SE tax on distributions
D. Reduces federal income tax to zero

### 39. The "Profit First" method splits revenue into approximately:
A. 1 account
B. 50 accounts
C. 5 accounts (Income, Profit, Owner Pay, Tax, Operating Expenses)
D. None
...
### 41. HSA is "triple-tax-advantaged" because:
A. Contributions deductible, growth tax-free, qualified withdrawals tax-free
B. Triple the income
C. Triple the limit
D. Three accounts

### 42. The PACT-O discovery framework stands for:
A. Pay-Action-Cost-Timing-Offer
B. Problem-Authority-Constraints-Target outcome-Other options
C. Process-Audit-Contract-Time-Outreach
D. Price-Anchor-Close-Test-Offer

### 43. In the 45-min discovery call, the buyer should talk approximately:
A. 10%
B. 70%
C. 50%
D. 100%

### 44. The end-of-call recap email should be sent within:
A. 30 minutes
B. 30 days
C. Never
D. Only when requested

### 45. The kickoff Loom (15 min) sent BEFORE the kickoff call approximately kills what % of "where are we?" emails?
A. 0%
B. 80%
C. 5%
D. 100%

### 46. The Friday weekly status email should be sent:
A. Daily
B. Friday afternoons even on quiet weeks
C. Only when problems arise
D. Annually

### 47. Retainer conversion rates from one-off productized clients typically run:
A. 25–45% baseline (60–80% with measurable outcomes)
B. 0–5%
C. 100% always
D. 0%

### 48. The testimonial ask should happen at approximately:
A. Day 0
B. Year 5
C. +21 days post-delivery (or +60 days into retainer)
D. Never

### 49. Which is the LEAST aligned with the capstone playbook?
A. Wedge locked + sample built + site live by Week 1
B. Build a 14-page custom proposal template before sending any cold emails
C. First discovery call Week 3–4
D. Outbound stack live + ICP list by Week 2

### 50. Across the entire 8-module course, the single overarching principle is:
A. Hire as many people as possible
B. Subscribe to every newsletter
C. Spend $5K/mo on tools
D. Pick a sharp wedge, productize, build sustainable financial systems, and use AI to deliver like a team of three
...
4. Try the question again 7 days later
...
**Why C is correct.** 100/10/1 = 100 named companies + 10 watering holes + 1 painful shared problem.

**Why the other options are wrong.** A/B/D conflate the test with funnel/training metrics.
...
**Why D is correct.** PVCC = Problem-Value-Credibility-Call.

**Why the other options are wrong.** A/B/C confuse PVCC with funnel acronyms or generic process labels.

**Exam-takeaway.** PVCC = Problem, Value, Credibility, Call.
...
**Why C is correct.** "Always be lowest in the market" is the *opposite* of the 5 pricing mindsets. The actual 5 are: outcome > time, buyer's wallet, never quote on call, anchor first, comfortable with no.

**Why the other options are wrong.** A/B/D are explicit pricing mindsets in the reading.

**Exam-takeaway.** Pricing mindsets don't include "always lowest." Lowest = race to zero.
...
**Why D is correct.** The 4-question test is: workflow, substitute, frequency, payback. "Did a competitor recommend it" is *not* one of the tests.

**Why the other options are wrong.** A/B/C are all explicit tests in the reading.

**Exam-takeaway.** 4-question test: workflow, substitute, frequency, payback.
...
**Exam-takeaway.** AI-refusal = hard-pass red flag in 2026 hiring.
...
**Exam-takeaway.** Don't perfect templates before getting clients. Ship the outbound first.
...
> ⚖️ This curriculum is operational education. Always consult a licensed attorney + CPA for legal, tax, and contract decisions specific to your situation.
