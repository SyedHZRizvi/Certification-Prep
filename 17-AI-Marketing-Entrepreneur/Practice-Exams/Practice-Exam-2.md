...
### 1. The biggest mistake new agency founders make in Year 1 positioning is:
A. Being too narrow
B. Hiring too few people
C. Charging too much
D. Being too generic ("I help businesses grow")

### 2. Brett Williams's Designjoy economics:
A. ~$100K ARR, 30 employees
B. ~$50M ARR Series B
C. ~$1.5M ARR solo, ~70% margin
D. Shut down in 2023

### 3. The 100/10/1 niche test confirms a wedge by validating:
A. 100 days, 10 hours, 1 sale
B. 100 leads, 10 calls, 1 close
C. 100 named companies, 10 watering holes, 1 painful shared problem
D. 100 channels, 10 deliverables, 1 product

### 4. A "stacked wedge" means niching on:
...
### 6. The "tripled price" exercise suggests most productized services sell at:
A. 1/3 the founder's gut price
B. The same as the founder's gut price
C. 10x the founder's gut price
D. 2–3x the founder's gut price

### 7. AI leverage is HIGHEST (5–8x) for which work type?
A. Audits and analysis work
B. Production filming
C. Discovery calls
D. Live workshops

### 8. The Year-1 channel default pair is:
A. Outbound + Inbound
B. Paid + Events
C. All seven channels
D. Referrals only

### 9. The PVCC cold email structure is:
A. Personal-Volume-Cadence-Call
B. Position-Value-Cost-Conversion
C. Problem-Value-Credibility-Call
D. Process-Audit-Cost-Conversion

### 10. Typical positive reply rate for a well-run cold email campaign is:
A. 50–70%
B. 0.1%
C. 25–40%
D. 2.5–5%

### 11. Paid ads typically profit only on ACV above:
A. $200
B. $1,000
C. $1M
D. $7,500

### 12. The "good-better-best" pricing structure typically results in what % picking the middle option?
A. 10%
B. 30%
C. 60–70%
D. 95%

### 13. Option C in good-better-best should be priced approximately:
A. Slightly cheaper than Option A
B. 2.5–3x Option A
C. The same as Option B
D. 100x Option A

### 14. A founder's healthy proposal close rate is:
A. 30–50%
B. 95–100%
C. 0–5%
D. 80%+
...
### 15. A kill fee is:
A. A bonus to the client
B. An employment termination
C. Penalty paid by the client mid-engagement cancellation (typically 25–50%)
D. A clause about IP

### 16. Year-1 solo tech stack target monthly cost is approximately:
A. $200/mo
B. $25/mo
C. $1,500/mo
D. $5,000/mo

### 17. The recommended outbound stack costs approximately:
A. $2,500/mo
B. $25/mo
C. $235/mo (Apollo + Smartlead + 3 inboxes + SalesNav)
D. Free

### 18. For most agency operators, the right automation tool by volume is:
A. Zapier always
B. Custom code only
...
B. Only Moz Pro
C. Neither
D. ONE of Ahrefs OR SEMrush

### 20. The 3 legitimate hiring triggers include:
A. Sustained 50+ hr/wk for 8+ weeks, specific bottleneck >15 hr/wk, active revenue being turned away
B. Wanting to look established
C. $1M ARR only
D. Anniversary of launch

### 21. The 1.5x rule says a new hire should:
A. Earn 1.5x their predecessor
...
### 22. The DECIDING interview step for AI-native hires is:
A. The application screen
B. The 30-min intro call
C. The PAID work-sample test (real task, 2–4 hours)
D. The final reference call

### 23. The AI-leverage multiplier per hire vs. 2020 baseline should target:
A. No improvement
B. Slower output
C. 100x
D. 3–5x output

### 24. The "tax bucket" rule says:
A. Save 10% annually
B. Transfer ~30% of every business deposit immediately to a tax savings account
C. Wait until April
D. Pay quarterly only

### 25. The recommended Year-1 entity for a US founder at $200K profit considering tax savings is:
A. Sole proprietor
B. C-corp
C. LLC + S-corp election (with reasonable salary + distributions)
D. Trust

### 26. US quarterly estimated tax deadlines are:
A. Monthly
B. Annually only
...
### 28. Gross margin target for productized services at scale is:
A. 0–10%
B. 60–80%
C. 95–100%
D. -20%

### 29. The PACT-O discovery framework stands for:
A. Pay-Action-Cost-Timing-Offer
B. Price-Anchor-Close-Test-Offer
C. Process-Audit-Contract-Time-Outreach
D. Problem-Authority-Constraints-Target outcome-Other options

### 30. In the 45-min discovery call, the buyer should talk approximately:
A. 10%
B. 50%
C. 100%
D. 70%

### 31. The end-of-call recap email should be sent:
A. Only if requested
B. Within 30 days
C. Never
D. Within 30 minutes of the call

### 32. The kickoff Loom approximately kills what % of "where are we?" emails?
A. 0%
B. 80%
C. 5%
D. 100%

### 33. The Friday weekly status email should be sent:
A. Friday afternoons, even on quiet weeks
B. Daily
C. Only when problems arise
D. Annually

### 34. The upsell window for converting project → retainer is:
A. Year 5
B. The 7-day post-delivery window when client is happiest
C. Day 0
D. Never

### 35. Retainer conversion rates from one-off productized clients typically run:
A. 25–45% (60–80% with measurable outcomes)
B. 0–5%
C. 100% always
D. 0%

### 36. The reading on contracts emphasizes:
A. Skip contracts for small engagements
B. Use the MSA + SOW structure, include kill fee + liability cap + AI disclosure; have a licensed attorney review the template
C. Sign whatever the client sends
D. Verbal agreements suffice

### 37. The "Vera 47-day" opening story landed her first contracted revenue of approximately:
A. $0
B. $11,500 + $27,000 retainer = $38,500
C. $1,500
D. $1M

### 38. The reading recommends a hiring source for international Filipino contractors:
A. OnlineJobs.ph ($69 lifetime employer fee)
B. LinkedIn Premium only
C. Buying email lists
D. Random Facebook groups

### 39. The "Profit First" method splits revenue into approximately how many accounts?
A. 1
B. 5 (Income, Profit, Owner Pay, Tax, Operating Expenses)
C. 20
D. 0

### 40. Which is the LEAST advisable financial action for a Year-1 founder?
A. Open business banking immediately
B. Set up the tax bucket (30% transfer rule)
C. Book a 1-hour CPA call
D. Skip quarterly estimates and "figure it out in April"
...
**Why C is correct.** Module 1's 100/10/1 test = 100 named companies + 10 watering holes + 1 painful shared problem.

**Why the other options are wrong.** A confuses time + practice metrics. B is generic sales-funnel math. D conflates with the three wedge axes.
...
**Why A is correct.** Module 3's default Year-1 pairing = Outbound + Inbound (cashflow + compounding).

**Why the other options are wrong.** B is capital-intensive. C is the "do nothing well" mistake. D assumes a network you don't yet have.

**Exam-takeaway.** Year-1 default = Outbound + Inbound.

**Q9. Answer: C**

**Why C is correct.** PVCC = Problem-Value-Credibility-Call. The 4-line structure for sub-110-word cold email.

**Why the other options are wrong.** A/B/D confuse PVCC with cadence (volume, conversion) or generic process acronyms.

**Exam-takeaway.** PVCC = Problem, Value, Credibility, Call. Under 110 words.
