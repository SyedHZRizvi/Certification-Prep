...
# 🎥 Module 7 Videos: Logistics, Distribution & Warehousing

> **How to use:** Logistics is visual. Watch the warehouse and transportation walk-throughs especially closely.
...
<div class="vg-grid">
  <a class="vg-card" data-video-id="YF1wBXoih3M" href="https://www.youtube.com/results?search_query=Transportation+modes+supply+chain+comparison" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      ...
      <p class="vg-title">5 Transportation Modes Compared</p>
  ...
  <a class="vg-card" data-video-id="wlwNksBSHxc" href="https://www.youtube.com/results?search_query=Warehouse+operations+receiving+picking+shipping" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">Warehouse Operations Walk-Through</p>
  ...
  <a class="vg-card" data-video-id="9J2pTNTksno" href="https://www.youtube.com/results?search_query=3PL+vs+4PL+logistics+provider+explained" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">3PL vs 4PL vs LLP Explained</p>
  ...
  <a class="vg-card" data-video-id="7hSE1PjbOkI" href="https://www.youtube.com/results?search_query=Intermodal+container+shipping+how+it+works" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">How Intermodal Container Shipping Works</p>
      <p class="vg-creator">Wendover Productions</p>
      <span class="vg-duration">⏱ 12 min · The McLean revolution</span>
    </div>
  </a>
</div>
...
<div class="vg-grid">
  ...
  <a class="vg-card" data-video-id="T_4bokK5VSk" href="https://www.youtube.com/results?search_query=Last+mile+delivery+innovation+e+commerce" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag recommended">Recommended</span>
      <p class="vg-title">Last-Mile Innovation in E-Commerce</p>
      <p class="vg-creator">CNBC</p>
  ...
  <a class="vg-card" data-video-id="bmfixQCNL3g" href="https://www.youtube.com/results?search_query=Reverse+logistics+returns+management" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag recommended">Recommended</span>
      <p class="vg-title">Reverse Logistics & Returns Management</p>
      <p class="vg-creator">Edureka SCM</p>
      <span class="vg-duration">⏱ 9 min · Closed-loop concept</span>
    </div>
  </a>
</div>
...
<div class="vg-grid">
  ...
  <a class="vg-card" data-video-id="znCAAeEx4w4" href="https://www.youtube.com/results?search_query=Container+shipping+history+Malcolm+McLean" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag optional">Optional</span>
      <p class="vg-title">The Box That Changed The World</p>
      <p class="vg-creator">CNBC Documentary</p>
  ...
  <a class="vg-card" data-video-id="pITW1nAq0U0" href="https://www.youtube.com/results?search_query=Cross+docking+vs+warehouse+storage" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag optional">Optional</span>
      <p class="vg-title">Cross-Docking vs Traditional Storage</p>
      <p class="vg-creator">GreyCampus</p>
      <span class="vg-duration">⏱ 12 min · When to use which</span>
    </div>
  </a>
</div>
...
| Channel | Why |
|---------|-----|
| **Operations Insider** | Detailed warehouse / mode coverage |
| **Wendover Productions** | Spectacular visuals on shipping |
| **CSCMP** | Industry trends and KPIs |
| **GreyCampus** | CSCP-aligned exam prep |
| **CNBC / Bloomberg** | Real-world logistics journalism |
...
1. Rank the 5 modes by cost and speed.
2. Define intermodal vs multimodal.
3. List 5 warehouse operations in order (receive → ship).
4. Distinguish 3PL from 4PL with one example each.
5. Why is perfect order considered the gold-standard service KPI?
