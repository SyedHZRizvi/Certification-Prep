...
# 🎥 Module 3 Videos: Demand & Forecasting

> **How to use:** Forecasting is *the* topic where doing the math by hand is essential. Pause the videos and try the example yourself before they show the answer.
...
<div class="vg-grid">
  ...
  <a class="vg-card" data-video-id="PIvvWrvFDvY" href="https://www.youtube.com/results?search_query=Exponential+smoothing+forecasting+example" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">Exponential Smoothing With Worked Example</p>
  ...
  <a class="vg-card" data-video-id="QXogeG5hNKs" href="https://www.youtube.com/results?search_query=CPFR+collaborative+planning+forecasting+replenishment" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag essential">Essential</span>
      <p class="vg-title">CPFR Process Explained</p>
      <p class="vg-creator">ASCM Official</p>
      <span class="vg-duration">⏱ 9 min · The 4 activities + benefits</span>
    </div>
  </a>
</div>
...
<div class="vg-grid">
  <a class="vg-card" data-video-id="3Jn_U8dMpf4" href="https://www.youtube.com/results?search_query=Moving+average+forecast+example" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      ...
      <p class="vg-title">Simple and Weighted Moving Average</p>
  ...
  <a class="vg-card" data-video-id="iAvZujE602U" href="https://www.youtube.com/results?search_query=Holt+Winters+forecasting+method+seasonality" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag recommended">Recommended</span>
      <p class="vg-title">Holt-Winters: Trend + Seasonality</p>
      <p class="vg-creator">Operations Insider</p>
...
<div class="vg-grid">
  <a class="vg-card" data-video-id="ESxuo1CePZI" href="https://www.youtube.com/results?search_query=Delphi+method+forecasting" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      ...
      <p class="vg-title">Delphi Forecasting Technique</p>
      <p class="vg-creator">365 Careers</p>
  ...
  <a class="vg-card" data-video-id="wuNcOsXkzpE" href="https://www.youtube.com/results?search_query=Demand+sensing+real+time+POS" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag optional">Optional</span>
      <p class="vg-title">Demand Sensing in Modern Supply Chains</p>
      <p class="vg-creator">Operations Insider</p>
  ...
  <a class="vg-card" data-video-id="fNybdd7nyUg" href="https://www.youtube.com/results?search_query=Croston+intermittent+demand+forecast" target="_blank" rel="noopener">
    ...
    <div class="vg-meta">
      <span class="vg-tag optional">Optional</span>
      <p class="vg-title">Croston's Method for Intermittent Demand</p>
      <p class="vg-creator">Caltech</p>
      <span class="vg-duration">⏱ 14 min · Spare parts forecasting</span>
    </div>
  </a>
</div>
...
| Channel | Why |
|---------|-----|
| **Operations Insider** | Numerical exam-style walkthroughs |
| **GreyCampus** | CSCP/CPIM prep with formulas |
| **Edureka SCM** | Long-form structured topics |
| **ASCM Official** | CPFR + APICS dictionary content |
...
1. Compute MAD, MAPE, and tracking signal for a 4-week forecast vs actual.
2. Run a simple exponential smoothing forecast for 3 periods (α = 0.2).
3. List the 4 CPFR activities.
4. What demand patterns require Holt-Winters? Why?
5. When would you forecast vs calculate demand?
