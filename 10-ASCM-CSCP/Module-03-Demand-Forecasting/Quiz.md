...
### Q1. Which type of demand should be CALCULATED rather than forecasted? *(Remember)*
A. Independent
B. Dependent
C. Seasonal
D. Lumpy
...
### Q2. Last period's forecast was 200, actual was 240, and α = 0.4. Using simple exponential smoothing, the next forecast is: *(Apply)*
A. 200
B. 216
C. 220
D. 240
...
### Q3. Which method best handles a product with steady upward trend AND yearly seasonality? *(Apply)*
A. Naïve
...
### Q4. A team measures forecast accuracy using MAPE, but MAPE is unreliable when: *(Understand)*
A. Actuals are large
...
### Q5. The Delphi method differs from a sales force composite because: *(Understand)*
...
### Q7. Choose the BEST forecasting method for a stable, level demand pattern with no trend or seasonality: *(Apply)*
A. Holt-Winters
...
### Q8. In simple exponential smoothing, raising α from 0.1 to 0.6: *(Analyze)*
...
### Q9. CPFR's primary contribution to bullwhip reduction comes from: *(Understand)*
...
### Q10. A spare-parts business with mostly zero-demand periods and occasional spikes is BEST forecast with: *(Apply)*
A. Simple ES
B. Linear regression
C. Croston's method
D. Holt's method
...
### Q11. Mean absolute deviation (MAD) for 4 errors of +10, −10, +20, −10 equals: *(Apply)*
A. 2.5
B. 10
C. 12.5
D. 50
...
### Q12. A regression model with R² = 0.89 indicates: *(Understand)*
...
### Q13. Demand sensing complements traditional statistical forecasting by: *(Understand)*
...
### Q14. Which is an example of demand SHAPING (not forecasting)? *(Apply)*
...
### Q15. VMI differs from CPFR because: *(Understand)*
...
### Q16. Forecast accuracy generally IMPROVES when: *(Analyze)*
...
### Q17. A retailer ran a deep promotion last week. Sales tripled. The forecasting team should: *(Evaluate)*
...
### Q18. The PRIMARY purpose of a tracking signal is to: *(Understand)*
A. Compute MAD
...
### Q19. Last 3 actuals: 80, 100, 120. Using a 3-period simple moving average, the next forecast is: *(Apply)*
A. 80
B. 90
C. 100
D. 120
...
### Q21. A retailer with new product launches and no history should rely MORE on: *(Apply)*
A. Causal models
...
### Q22. Compared to a low α, a high α in exponential smoothing produces: *(Understand)*
...
### Q23. Bias (MFE) of +12 over 6 periods means on average the forecast was: *(Apply)*
...
### Q25. A grocery chain shares POS data with its dairy supplier, and the supplier maintains agreed inventory levels at each store. This is: *(Apply)*
A. CPFR
B. VMI
C. MRP
D. Drop-ship
...
### Q26. The most accurate way to forecast a 5-year product family revenue plan is: *(Evaluate)*
