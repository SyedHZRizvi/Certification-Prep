...
# Module 9 Videos — Ayatul Kursi, Yasin, Al-Mulk, Al-Kahf

<div class="vg-grid" markdown="0">

<a class="vg-card" href="https://www.youtube.com/results?search_query=ayatul+kursi+meaning+explanation+tafseer+greatest+verse" target="_blank">
  <div class="vg-thumb">👑<div class="vg-play">▶</div></div>
  <div class="vg-meta">
    <span class="vg-tag essential">Essential</span>
    <p class="vg-title">Ayatul Kursi — Meaning, Virtues and Nine Divine Attributes</p>
    <p class="vg-creator">Quran Tafseer</p>
    <p class="vg-duration">30 min</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=surah+yasin+complete+recitation+tafseer+heart+quran" target="_blank">
  <div class="vg-thumb">💚<div class="vg-play">▶</div></div>
  <div class="vg-meta">
    <span class="vg-tag essential">Essential</span>
    <p class="vg-title">Surah Yasin — Complete with Meaning and Tafseer</p>
    <p class="vg-creator">Islamic Scholars</p>
    <p class="vg-duration">60 min</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=surah+mulk+tafseer+meaning+explanation+protect+grave" target="_blank">
  <div class="vg-thumb">🌙<div class="vg-play">▶</div></div>
  <div class="vg-meta">
    <span class="vg-tag essential">Essential</span>
    <p class="vg-title">Surah Al-Mulk — Protection from the Grave + Full Tafseer</p>
    <p class="vg-creator">Quran Explained</p>
    <p class="vg-duration">45 min</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=surah+kahf+friday+four+stories+meaning+tafseer" target="_blank">
  <div class="vg-thumb">📜<div class="vg-play">▶</div></div>
  <div class="vg-meta">
    <span class="vg-tag essential">Essential</span>
    <p class="vg-title">Surah Al-Kahf — Four Stories and Their Lessons</p>
    <p class="vg-creator">Quran Stories</p>
    <p class="vg-duration">50 min</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=ayatul+kursi+memorization+learning+word+by+word" target="_blank">
  <div class="vg-thumb">📖<div class="vg-play">▶</div></div>
  <div class="vg-meta">
    <span class="vg-tag recommended">Recommended</span>
    <p class="vg-title">Ayatul Kursi — Word by Word Memorization Guide</p>
    <p class="vg-creator">Hifz Helper</p>
    <p class="vg-duration">25 min</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=surah+kahf+ten+verses+protection+dajjal+why+friday" target="_blank">
  <div class="vg-thumb">🛡️<div class="vg-play">▶</div></div>
  <div class="vg-meta">
    <span class="vg-tag recommended">Recommended</span>
    <p class="vg-title">Why Surah Al-Kahf on Friday — Protection from Dajjal</p>
    <p class="vg-creator">Islamic Reminders</p>
    <p class="vg-duration">20 min</p>
  </div>
</a>

<a class="vg-card" href="https://www.youtube.com/results?search_query=surah+yasin+benefits+when+recite+dying+thursday+night" target="_blank">
  <div class="vg-thumb">🌿<div class="vg-play">▶</div></div>
  <div class="vg-meta">
    <span class="vg-tag recommended">Recommended</span>
    <p class="vg-title">Surah Yasin — When and Why to Recite It</p>
    <p class="vg-creator">Sunnah Guide</p>
